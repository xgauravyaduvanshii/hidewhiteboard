...
const FeatureList = [
  {
    title: "Learn how hidewhiteboard works",
    Svg: require("@site/static/img/undraw_innovative.svg").default,
    description: (
      <>Want to contribute to hidewhiteboard but got lost in the codebase?</>
    ),
  },
  {
    title: "Integrate hidewhiteboard",
    Svg: require("@site/static/img/undraw_blank_canvas.svg").default,
    description: (
      <>
        Want to build your own app powered by hidewhiteboard but don't know where to
        start?
      </>
    ),
  },
