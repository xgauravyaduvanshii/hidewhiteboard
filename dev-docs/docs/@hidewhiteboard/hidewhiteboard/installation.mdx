...
**If you don't want to wait for the next stable release and try out the unreleased changes you can use `@hidewhiteboard/hidewhiteboard@next`.**
...
<head>
    <script>
        window.HIDEWHITEBOARD_ASSET_PATH = "https://my.cdn.com/assets/";
    </script>    
</head>
```
