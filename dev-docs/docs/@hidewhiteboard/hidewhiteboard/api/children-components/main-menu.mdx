...
By default hidewhiteboard will render the `MainMenu` with default options. If you want to customise the `MainMenu`, you can pass the `MainMenu` component with the list options.
    ...
    <div style={{ height: "500px" }}>
      <hidewhiteboard>
        <MainMenu>
          ...
          <MainMenu.ItemLink href="https://github.com/xgauravyaduvanshii/hidewhiteboard">
            hidewhiteboard
          </MainMenu.ItemLink>
        </MainMenu>
      </hidewhiteboard>
...
For the items which are shown in the menu in [hidewhiteboard.com](https://github.com/xgauravyaduvanshii/hidewhiteboard), you can use `MainMenu.DefaultItems`
...
Here is a [complete list](https://github.com/xgauravyaduvanshii/hidewhiteboard/blob/master/packages/hidewhiteboard/components/main-menu/DefaultItems.tsx) of the default items.
...
function App() {
  return (
    <div style={{ height: "500px" }}>
      <hidewhiteboard>
        <MainMenu>
          <MainMenu.Group title="hidewhiteboard items">
            <MainMenu.DefaultItems.Socials />
            <MainMenu.DefaultItems.Export />
          </MainMenu.Group>
