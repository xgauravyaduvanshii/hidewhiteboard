...
Pull requests are welcome. For major changes, please [open an issue](https://github.com/xgauravyaduvanshii/hidewhiteboard/issues/new) first to discuss what you would like to change.

We have a [roadmap](https://github.com/orgs/hidewhiteboard/projects/3) which we strongly recommend to go through and check if something interests you.
...
>
> ```bash
> git remote add upstream https://github.com/xgauravyaduvanshii/hidewhiteboard
> git fetch upstream
...
1. Go to https://codesandbox.io/p/github/hidewhiteboard/hidewhiteboard
...
To translate hidewhiteboard into other languages, please visit [our Crowdin page](https://crowdin.com/project/hidewhiteboard). To add a new language, [open an issue](https://github.com/xgauravyaduvanshii/hidewhiteboard/issues/new) so we can get things set up on our end first.
