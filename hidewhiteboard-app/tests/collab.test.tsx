import { CaptureUpdateAction, newElementWith } from "@hidewhiteboard/hidewhiteboard";
import {
  createRedoAction,
  createUndoAction,
} from "@hidewhiteboard/hidewhiteboard/actions/actionHistory";
import { syncInvalidIndices } from "@hidewhiteboard/element";
import { API } from "@hidewhiteboard/hidewhiteboard/tests/helpers/api";
import { act, render, waitFor } from "@hidewhiteboard/hidewhiteboard/tests/test-utils";
import { vi } from "vitest";

import { StoreIncrement } from "@hidewhiteboard/element";

import type { DurableIncrement, EphemeralIncrement } from "@hidewhiteboard/element";
...
vi.mock("../../hidewhiteboard-app/data/firebase.ts", () => {
