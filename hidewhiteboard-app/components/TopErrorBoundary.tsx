...
> {
  ...
  private async createSupportEmail() {
    let body = "";
    try {
      const templateStrFn = (
        await import(
    ...
    window.open(`mailto:xgauravyaduvanshii@gmail.com?body=${body}`, "_blank");
  }

  private errorSplash() {
    return (
      <div className="ErrorSplash hidewhiteboard">
          ...
          <div>
            ...
            <div className="ErrorSplash-paragraph">
              <Trans
                ...
                button={(el) => (
                  <button onClick={() => this.createSupportEmail()}>
                    {el}
                  </button>
                )}
              />
