...
interface ImportMetaEnv {
  ...
  // set this only if using the collaboration workflow we use on hidewhiteboard.com
  VITE_APP_PORTAL_URL: string;
  VITE_APP_AI_BACKEND: string;
  VITE_APP_FDD_BACKEND_URL: string;
  VITE_APP_FDD_API_KEY: string;
  VITE_APP_MCP_SERVER_URL: string;
