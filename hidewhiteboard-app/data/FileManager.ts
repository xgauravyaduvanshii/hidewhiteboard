...
import { compressData } from "@hidewhiteboard/hidewhiteboard/data/encode";
...
export class FileManager {
  /** files being fetched */
  private fetchingFiles = new Map<hidewhiteboardImageElement["fileId"], true>();
  private erroredFiles_fetch = new Map<
    hidewhiteboardImageElement["fileId"],
    true
  >();
  /** files being saved */
  ...
  private savedFiles = new Map<hidewhiteboardImageElement["fileId"], FileVersion>();
   ...
   */
  shouldPreventUnload = (elements: readonly hidewhiteboardElement[]) => {
...
export const updateStaleImageStatuses = (params: {
  ...
  params.hidewhiteboardAPI.updateScene({
    elements: params.hidewhiteboardAPI
