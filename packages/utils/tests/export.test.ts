...
import * as mockedSceneExportUtils from "@hidewhiteboard/hidewhiteboard/scene/export";
import { diagramFactory } from "@hidewhiteboard/hidewhiteboard/tests/fixtures/diagramFixture";
