import { arrayToMap, type Bounds } from "@hidewhiteboard/common";
import { getElementBounds } from "@hidewhiteboard/element";
import {
  isArrowElement,
  ishidewhiteboardElement,
  isFreeDrawElement,
  isLinearElement,
  isTextElement,
...
type Element = NonDeletedhidewhiteboardElement;
type Elements = readonly NonDeletedhidewhiteboardElement[];
...
const getNonLinearElementRelativePoints = (
  element: Exclude<
    Element,
    hidewhiteboardLinearElement | hidewhiteboardFreeDrawElement
  >,
): [
  TopLeft: LocalPoint,
  TopRight: LocalPoint,
...
/** @returns vertices relative to element's top-left [0,0] position  */
const getElementRelativePoints = (element: hidewhiteboardElement): Points => {
...
export const elementsOverlappingBBox = ({
  ...
  elements: Elements;
  bounds: Bounds | hidewhiteboardElement;
  ...
  if (ishidewhiteboardElement(bounds)) {
