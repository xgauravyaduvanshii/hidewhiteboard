...
describe("normalizeLink", () => {
  ...
  it("should sanitize links", () => {
    ...
    expect(normalizeLink("https://github.com/xgauravyaduvanshii/hidewhiteboard")).toBe(
      "https://github.com/xgauravyaduvanshii/hidewhiteboard",
    );
    expect(normalizeLink("www.hidewhiteboard.com")).toBe("www.hidewhiteboard.com");
    expect(normalizeLink("/ola")).toBe("/ola");
