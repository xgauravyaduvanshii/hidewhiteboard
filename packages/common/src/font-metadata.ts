...
export interface FontMetadata {
  ...
  metrics: {
    ...
    descender: number;
    /** harcoded unitless line-height, https://github.com/xgauravyaduvanshii/hidewhiteboard/pull/6360#issuecomment-1477635971 */
    lineHeight: number;
  };
...
export const getVerticalOffset = (
  fontFamily: hidewhiteboardTextElement["fontFamily"],
...
export const getLineHeight = (fontFamily: FontFamilyValues) => {
  ...
  return lineHeight as hidewhiteboardTextElement["lineHeight"];
};
