...
import type { AppProps, AppState } from "@hidewhiteboard/hidewhiteboard/types";
...
export const APP_NAME = "HideWhiteboard";
...
export enum EVENT {
  ...
  SCROLL = "scroll",
  // custom events
  HIDEWHITEBOARD_LINK = "hidewhiteboard-link",
...
export const FRAME_STYLE = {
  strokeColor: "#bbb" as hidewhiteboardElement["strokeColor"],
  strokeWidth: 2 as hidewhiteboardElement["strokeWidth"],
  strokeStyle: "solid" as hidewhiteboardElement["strokeStyle"],
  fillStyle: "solid" as hidewhiteboardElement["fillStyle"],
  roughness: 0 as hidewhiteboardElement["roughness"],
  roundness: null as hidewhiteboardElement["roundness"],
  backgroundColor: "transparent" as hidewhiteboardElement["backgroundColor"],
  radius: 8,
  nameOffsetY: 3,
...
export const STRING_MIME_TYPES = {
  ...
  // hidewhiteboard data
  hidewhiteboard: "application/vnd.hidewhiteboard+json",
  hidewhiteboardClipboard: "application/vnd.hidewhiteboard.clipboard+json",
  // LEGACY: fully-qualified library JSON data
  hidewhiteboardlib: "application/vnd.hidewhiteboardlib+json",
  // list of hidewhiteboard library item ids
  hidewhiteboardlibIds: "application/vnd.hidewhiteboardlib.ids+json",
} as const;

export const MIME_TYPES = {
  ...STRING_MIME_TYPES,
  // image-encoded hidewhiteboard data
  "hidewhiteboard.svg": "image/svg+xml",
  "hidewhiteboard.png": "image/png",
  // binary
...
export const EXPORT_DATA_TYPES = {
  ...
  hidewhiteboardClipboard: "hidewhiteboard/clipboard",
  hidewhiteboardLibrary: "hidewhiteboardlib",
  hidewhiteboardClipboardWithAPI: "hidewhiteboard-api/clipboard",
} as const;

export const getExportSource = () =>
  window.HIDEWHITEBOARD_EXPORT_SOURCE || window.location.origin;
...
export const DEFAULT_ELEMENT_PROPS: {
  strokeColor: hidewhiteboardElement["strokeColor"];
  backgroundColor: hidewhiteboardElement["backgroundColor"];
  fillStyle: hidewhiteboardElement["fillStyle"];
  strokeWidth: hidewhiteboardElement["strokeWidth"];
  strokeStyle: hidewhiteboardElement["strokeStyle"];
  roughness: hidewhiteboardElement["roughness"];
  opacity: hidewhiteboardElement["opacity"];
  locked: hidewhiteboardElement["locked"];
} = {
...
export const EDITOR_LS_KEYS = {
  OAI_API_KEY: "hidewhiteboard-oai-api-key",
  // legacy naming (non)scheme
  MERMAID_TO_HIDEWHITEBOARD: "mermaid-to-hidewhiteboard",
