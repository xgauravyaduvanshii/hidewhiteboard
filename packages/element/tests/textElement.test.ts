import { getLineHeight } from "@hidewhiteboard/common";
import { API } from "@hidewhiteboard/hidewhiteboard/tests/helpers/api";

import { FONT_FAMILY, TEXT_ALIGN, VERTICAL_ALIGN } from "@hidewhiteboard/common";
...
import type { hidewhiteboardTextElementWithContainer } from "../src/types";
