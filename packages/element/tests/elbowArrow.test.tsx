import { ARROW_TYPE } from "@hidewhiteboard/common";
import { pointFrom } from "@hidewhiteboard/math";
import { Hidewhiteboard } from "@hidewhiteboard/hidewhiteboard";
import { actionSelectAll } from "@hidewhiteboard/hidewhiteboard/actions";
import { actionDuplicateSelection } from "@hidewhiteboard/hidewhiteboard/actions/actionDuplicateSelection";
import { API } from "@hidewhiteboard/hidewhiteboard/tests/helpers/api";
import { Pointer, UI } from "@hidewhiteboard/hidewhiteboard/tests/helpers/ui";
import {
  act,
  fireEvent,
  GlobalTestState,
...
import { bindBindingElement } from "@hidewhiteboard/element";
...
describe("elbow arrow segment move", () => {
  ...
  it("can move the second segment of an unconnected elbow arrow", () => {
    ...
    const arrow = h.scene.getSelectedElements(
      h.state,
    )[0] as hidewhiteboardArrowElement;
...
describe("elbow arrow routing", () => {
  ...
  it("can properly generate orthogonal arrow points", () => {
    ...
    const arrow = API.createElement({
      type: "arrow",
      elbowed: true,
    }) as hidewhiteboardElbowArrowElement;
...
describe("elbow arrow ui", () => {
  ...
  it("keeps arrow shape when the whole set of arrow and bindables are duplicated", async () => {
    ...
    const duplicatedArrow = h.scene.getSelectedElements(
      h.state,
    )[2] as hidewhiteboardArrowElement;
