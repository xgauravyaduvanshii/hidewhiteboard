...
import { UI, Keyboard, Pointer } from "@hidewhiteboard/hidewhiteboard/tests/helpers/ui";
import {
  render,
  unmountComponent,
...
describe("line element", () => {
  ...
  it("resizes", async () => {
    ...
    const element = h.elements[0] as hidewhiteboardLinearElement;
...
describe("text element", () => {
  ...
  it("can be resized from e", async () => {
    const text = UI.createElement("text");
    await UI.editText(text, "hidewhiteboard\nEditor");
