...
import { actionWrapTextInContainer } from "@hidewhiteboard/hidewhiteboard/actions/actionBoundText";

import { Hidewhiteboard, isLinearElement } from "@hidewhiteboard/hidewhiteboard";

import { API } from "@hidewhiteboard/hidewhiteboard/tests/helpers/api";
import { UI, Pointer, Keyboard } from "@hidewhiteboard/hidewhiteboard/tests/helpers/ui";
import {
  act,
  fireEvent,
  render,
...
import { defaultLang, setLanguage } from "@hidewhiteboard/hidewhiteboard/i18n";
...
describe("binding for simple arrows", () => {
  describe("when both endpoints are bound inside the same element", () => {
    ...
    it("should create an `inside` binding", () => {
      ...
      const arrow = API.getSelectedElement() as hidewhiteboardLinearElement;
  ...
  describe("additional binding behavior", () => {
    ...
    it("should unbind arrow when arrow is rotated", () => {
      ...
      const arrow = API.getSelectedElement() as hidewhiteboardArrowElement;
