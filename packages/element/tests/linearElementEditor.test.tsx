import { pointCenter, pointFrom } from "@hidewhiteboard/math";
...
import * as InteractiveCanvas from "@hidewhiteboard/hidewhiteboard/renderer/interactiveScene";
import * as StaticScene from "@hidewhiteboard/hidewhiteboard/renderer/staticScene";
import { API } from "@hidewhiteboard/hidewhiteboard/tests/helpers/api";

import { Keyboard, Pointer, UI } from "@hidewhiteboard/hidewhiteboard/tests/helpers/ui";
import {
  screen,
  render,
  fireEvent,
...
import type { GlobalPoint, LocalPoint } from "@hidewhiteboard/math";
...
} from "../../hidewhiteboard/tests/queries/dom";
...
describe("Test Linear Elements", () => {
  ...
  beforeEach(async () => {
    ...
    reseed(7);
    const comp = await render(<Hidewhiteboard handleKeyboardGlobally={true} />);
    h.state.width = 1000;
    h.state.height = 1000;
  ...
  const createTwoPointerLinearElement = (
    ...
    roundness: hidewhiteboardElement["roundness"] = null,
    roughness: hidewhiteboardLinearElement["roughness"] = 0,
  ) => {
  ...
  const enterLineEditingMode = (
    line: hidewhiteboardLinearElement,
  ...
  it("should not drag line and add midpoint until dragged beyond a threshold", () => {
    ...
    const line = h.elements[0] as hidewhiteboardLinearElement;
  ...
  it("should allow dragging line from midpoint in 2 pointer lines outside editor", async () => {
    ...
    expect((h.elements[0] as hidewhiteboardLinearElement).points.length).toEqual(2);
  ...
  it("shouldn't create text element on double click in line editor (arrow)", async () => {
    createTwoPointerLinearElement("arrow");
    const arrow = h.elements[0] as hidewhiteboardLinearElement;
  ...
  describe("Inside editor", () => {
    ...
    it("should update the midpoints when element roundness changed", async () => {
      ...
      const midPointsWithRoundEdge = LinearElementEditor.getEditorMidPoints(
        h.elements[0] as hidewhiteboardLinearElement,
        h.app.scene.getNonDeletedElementsMap(),
        h.state,
      );
    ...
    describe("When edges are round", () => {
      ...
      let line: hidewhiteboardLinearElement;
      ...
      it("should allow dragging lines from midpoints in between segments", async () => {
        ...
        expect((h.elements[0] as hidewhiteboardLinearElement).points)
  ...
  describe("Test bound text element", () => {
    ...
    const createBoundTextElement = (
      text: string,
      container: hidewhiteboardLinearElement,
    ) => {
      const textElement = API.createElement({
        ...
        width: 30,
        height: 20,
      }) as hidewhiteboardTextElementWithContainer;
      ...
      const elements: hidewhiteboardElement[] = [];
    ...
    it("should bind text to arrow when double clicked", async () => {
      ...
      expect(
        (h.elements[1] as hidewhiteboardTextElementWithContainer).text,
      ).toMatchSnapshot();
    });
    ...
    it("should bind text to arrow when clicked on arrow and enter pressed", async () => {
      ...
      const textElement = h.elements[1] as hidewhiteboardTextElementWithContainer;
    ...
    it("should wrap the bound text when arrow bound container moves", async () => {
      ...
      const textElement = h.elements[2] as hidewhiteboardTextElementWithContainer;
    ...
    it("should not update label position when arrow dragged", () => {
      createTwoPointerLinearElement("arrow");
      let arrow = h.elements[0] as hidewhiteboardLinearElement;
      createBoundTextElement(DEFAULT_TEXT, arrow);
      let label = h.elements[1] as hidewhiteboardTextElementWithContainer;
      ...
      arrow = h.elements[0] as hidewhiteboardLinearElement;
      label = h.elements[1] as hidewhiteboardTextElementWithContainer;
