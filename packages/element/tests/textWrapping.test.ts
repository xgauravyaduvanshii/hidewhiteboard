...
describe("Test wrapText", () => {
  ...
  it("should wrap the text correctly when word length is exactly equal to max width", () => {
    const text = "Hello hidewhiteboard";
    // Length of "hidewhiteboard" is 100 and exacty equal to max width
...
공백 줄바꿈\n전각기호…—`);
  ...
  describe("Test parseTokens", () => {
    it("should tokenize latin", () => {
      let text = "hidewhiteboard is a virtual collaborative whiteboard";
