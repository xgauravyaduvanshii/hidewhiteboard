...
import type { GlobalPoint, LineSegment, LocalPoint } from "@hidewhiteboard/math";

import type { AppState, Zoom } from "@hidewhiteboard/hidewhiteboard/types";
...
export const getElementWithTransformHandleType = (
  ...
  }, null as { element: NonDeletedhidewhiteboardElement; transformHandleType: MaybeTransformHandleType } | null);
};
