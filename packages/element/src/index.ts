import { toIterable } from "@hidewhiteboard/common";
 ...
 */
export const getSceneVersion = (elements: readonly hidewhiteboardElement[]) =>
...
export const getVisibleElements = (elements: readonly hidewhiteboardElement[]) =>
  elements.filter(
    (el) => !el.isDeleted && !isInvisiblySmallElement(el),
  ) as readonly NonDeletedhidewhiteboardElement[];

export const getNonDeletedElements = <T extends hidewhiteboardElement>(
  elements: readonly T[],
) =>
  elements.filter((element) => !element.isDeleted) as readonly NonDeleted<T>[];

export const isNonDeletedElement = <T extends hidewhiteboardElement>(
  element: T,
