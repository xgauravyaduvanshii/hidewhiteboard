import { invariant, isTransparent, type Bounds } from "@hidewhiteboard/common";
import {
...
} from "@hidewhiteboard/math/ellipse";
...
import type { FrameNameBounds } from "@hidewhiteboard/hidewhiteboard/types";
...
export const shouldTestInside = (element: hidewhiteboardElement) => {
...
let cachedElement: WeakRef<hidewhiteboardElement> | null = null;
...
export const getAllHoveredElementAtPoint = (
  ...
  elementsMap: NonDeletedSceneElementsMap,
  tolerance?: number,
): NonDeleted<hidewhiteboardBindableElement>[] => {
  const candidateElements: NonDeleted<hidewhiteboardBindableElement>[] = [];
...
export const getHoveredElementForBinding = (
  ...
  elementsMap: NonDeletedSceneElementsMap,
  tolerance?: number,
): NonDeleted<hidewhiteboardBindableElement> | null => {
  ...
  return candidateElements
    ...
    .pop() as NonDeleted<hidewhiteboardBindableElement>;
};
...
export const getHoveredElementForFocusPoint = (
  ...
  elementsMap: NonDeletedSceneElementsMap,
  tolerance?: number,
): hidewhiteboardBindableElement | null => {
  const candidateElements: NonDeleted<hidewhiteboardBindableElement>[] = [];
  // We need to to hit testing from front (end of the array) to back (beginning of the array)
  // because array is ordered from lower z-index to highest and we want element z-index
  // with higher z-index
  ...
  return distanceFilteredCandidateElements[0] as NonDeleted<hidewhiteboardBindableElement>;
};
...
const intersectLinearOrFreeDrawWithLineSegment = (
  element: hidewhiteboardLinearElement | hidewhiteboardFreeDrawElement,
  segment: LineSegment<GlobalPoint>,
  onlyFirst = false,
): GlobalPoint[] => {
...
const intersectRectanguloidWithLineSegment = (
  element: hidewhiteboardRectanguloidElement,
  elementsMap: ElementsMap,
  segment: LineSegment<GlobalPoint>,
  offset: number = 0,
  onlyFirst = false,
...
const intersectDiamondWithLineSegment = (
  element: hidewhiteboardDiamondElement,
  elementsMap: ElementsMap,
...
const intersectEllipseWithLineSegment = (
  element: hidewhiteboardEllipseElement,
  elementsMap: ElementsMap,
  l: LineSegment<GlobalPoint>,
  offset: number = 0,
): GlobalPoint[] => {
...
export const isBindableElementInsideOtherBindable = (
  innerElement: hidewhiteboardBindableElement,
  outerElement: hidewhiteboardBindableElement,
  elementsMap: ElementsMap,
): boolean => {
