...
const recomputeOrigin = (
  stateAtCropStart: NonDeleted<hidewhiteboardElement>,
  transformHandle: TransformHandleType,
  width: number,
  height: number,
...
// refer to https://link.hidewhiteboard.com/l/6rfy1007QOo/6stx5PmRn0k
export const getUncroppedImageElement = (
  ...
  if (element.crop) {
    ...
    const uncroppedElement: hidewhiteboardImageElement = {
      ...element,
...
export const getUncroppedWidthAndHeight = (element: hidewhiteboardImageElement) => {
  if (element.crop) {
    const width =
