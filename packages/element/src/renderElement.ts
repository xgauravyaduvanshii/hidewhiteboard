...
const getCanvasPadding = (element: hidewhiteboardElement) => {
  switch (element.type) {
    case "freedraw":
...
export const getRenderOpacity = (
  element: hidewhiteboardElement,
  containingFrame: hidewhiteboardFrameLikeElement | null,
  elementsPendingErasure: ElementsPendingErasure,
  pendingNodes: Readonly<PendinghidewhiteboardElements> | null,
...
export interface hidewhiteboardElementWithCanvas {
  element: hidewhiteboardElement | hidewhiteboardTextElement;
  ...
  imageCrop: hidewhiteboardImageElement["crop"] | null;
...
): hidewhiteboardElementWithCanvas | null => {
...
export const elementWithCanvasCache = new WeakMap<
  hidewhiteboardElement,
  hidewhiteboardElementWithCanvas
>();
...
const drawElementFromCanvas = (
  elementWithCanvas: hidewhiteboardElementWithCanvas,
  context: CanvasRenderingContext2D,
  renderConfig: StaticCanvasRenderConfig,
  appState: StaticCanvasAppState | InteractiveCanvasAppState,
