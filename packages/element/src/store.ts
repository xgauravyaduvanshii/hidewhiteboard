...
import type App from "@hidewhiteboard/hidewhiteboard/components/App";

import type { DTO, ValueOf } from "@hidewhiteboard/common/utility-types";

import type { AppState, ObservedAppState } from "@hidewhiteboard/hidewhiteboard/types";
  ...
  public scheduleMicroAction(
    params:
      | {
          ...
          elements: readonly hidewhiteboardElement[] | undefined;
...
export class StoreChange {
  ...
  private constructor(
    public readonly elements: Record<string, OrderedhidewhiteboardElement>,
...
export class StoreSnapshot {
  ...
  public getChangedElements(prevSnapshot: StoreSnapshot) {
    const changedElements: Record<string, OrderedhidewhiteboardElement> = {};
