...
import type { PointerDownState } from "@hidewhiteboard/hidewhiteboard/types";
...
export const transformElements = (
  ...
  selectedElements: readonly NonDeletedhidewhiteboardElement[],
  scene: Scene,
...
const rotateSingleElement = (
  ...
  let update: ElementUpdate<NonDeletedhidewhiteboardElement> = {
    angle,
  };
  ...
  if (isBindingElement(element)) {
    update = {
      ...update,
    } as ElementUpdate<hidewhiteboardArrowElement>;
  ...
  if (boundTextElementId) {
    const textElement =
      scene.getElement<hidewhiteboardTextElementWithContainer>(boundTextElementId);
...
export const measureFontSizeFromWidth = (
  element: NonDeleted<hidewhiteboardTextElement>,
...
export const resizeSingleTextElement = (
  origElement: NonDeleted<hidewhiteboardTextElement>,
  element: NonDeleted<hidewhiteboardTextElement>,
  scene: Scene,
  ...
  if (transformHandleType === "e" || transformHandleType === "w") {
    ...
    const resizedElement: Partial<hidewhiteboardTextElement> = {
...
export const getResizeArrowDirection = (
  transformHandleType: MaybeTransformHandleType,
  element: NonDeleted<hidewhiteboardLinearElement>,
): "origin" | "end" => {
...
export const resizeSingleElement = (
  ...
  origElement: hidewhiteboardElement,
  ...
  if (
    ...
    let updates: ElementUpdate<hidewhiteboardElement> = {
      ...newOrigin,
...
export const resizeMultipleElements = (
  ...
  const targetElements = selectedElements.reduce(
    (
      acc: {
        ...
        orig: NonDeletedhidewhiteboardElement;
        /** latest element */
        latest: NonDeletedhidewhiteboardElement;
      }[],
      element,
    ) => {
  ...
  if (nextWidth && nextHeight) {
    ...
    const elementsAndUpdates: {
      element: NonDeletedhidewhiteboardElement;
      update: Mutable<
        Pick<hidewhiteboardElement, "x" | "y" | "width" | "height" | "angle">
      > & {
        points?: hidewhiteboardLinearElement["points"];
        fontSize?: hidewhiteboardTextElement["fontSize"];
        scale?: hidewhiteboardImageElement["scale"];
        boundTextFontSize?: hidewhiteboardTextElement["fontSize"];
        startBinding?: hidewhiteboardElbowArrowElement["startBinding"];
        endBinding?: hidewhiteboardElbowArrowElement["endBinding"];
        fixedSegments?: hidewhiteboardElbowArrowElement["fixedSegments"];
      };
    }[] = [];
    ...
    for (const { orig, latest } of targetElements) {
      ...
      ) as hidewhiteboardTextElementWithContainer | undefined;
