...
export const dragSelectedElements = (
  ...
  _selectedElements: NonDeletedhidewhiteboardElement[],
  ...
  const elementsToUpdate = new Set<NonDeletedhidewhiteboardElement>(
    selectedElements,
  );
...
export const dragNewElement = ({
  ...
  newElement: NonDeletedhidewhiteboardElement;
