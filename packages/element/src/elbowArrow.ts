...
import {
  type hidewhiteboardElbowArrowElement,
...
type ElbowArrowData = {
  ...
  endHeading: Heading;
  commonBounds: Bounds;
  hoveredStartElement: hidewhiteboardBindableElement | null;
  hoveredEndElement: hidewhiteboardBindableElement | null;
};
...
const handleSegmentMove = (
  ...
  hoveredStartElement: hidewhiteboardBindableElement | null,
  hoveredEndElement: hidewhiteboardBindableElement | null,
): ElementUpdate<hidewhiteboardElbowArrowElement> => {
...
export const updateElbowArrowPoints = (
  arrow: Readonly<hidewhiteboardElbowArrowElement>,
  elementsMap: NonDeletedSceneElementsMap,
  updates: {
...
const normalizeArrowElementUpdate = (
  ...
  startIsSpecial?: hidewhiteboardElbowArrowElement["startIsSpecial"],
  endIsSpecial?: hidewhiteboardElbowArrowElement["startIsSpecial"],
): ElementUpdate<hidewhiteboardElbowArrowElement> => {
...
const getGlobalPoint = (
  ...
  element?: hidewhiteboardBindableElement | null,
  elementsMap?: ElementsMap,
  isDragging?: boolean,
): GlobalPoint => {
  if (isDragging) {
...
const getBindPointHeading = (
  ...
  hoveredElement: hidewhiteboardBindableElement | null | undefined,
