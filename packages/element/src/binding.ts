...
import type { LineSegment, LocalPoint, Radians } from "@hidewhiteboard/math";
import type { AppState } from "@hidewhiteboard/hidewhiteboard/types";
import type { MapEntry, Mutable } from "@hidewhiteboard/common/utility-types";
import type { Bounds } from "@hidewhiteboard/common";
...
import type {
  ...
  hidewhiteboardRectanguloidElement,
...
export type BindingStrategy =
  ...
  | {
      mode: BindMode;
      element: NonDeleted<hidewhiteboardBindableElement>;
...
export const getBindingGap = (
  bindTarget: hidewhiteboardBindableElement,
  opts: Pick<hidewhiteboardArrowElement, "elbowed">,
): number => {
  return (
...
export const bindOrUnbindBindingElement = (
  arrow: NonDeleted<hidewhiteboardArrowElement>,
...
const bindingStrategyForElbowArrowEndpointDragging = (
  ...
  elements: readonly Ordered<NonDeletedhidewhiteboardElement>[],
  zoom?: AppState["zoom"],
): {
...
const bindingStrategyForSimpleArrowEndpointDragging_complex = (
  ...
  const oppositeElement = oppositeBinding
    ? (elementsMap.get(oppositeBinding.elementId) as hidewhiteboardBindableElement)
    : null;
...
const getBindingStrategyForDraggingBindingElementEndpoints_simple = (
  ...
  const otherBindableElement = otherBinding
    ? (elementsMap.get(
      ...
      ) as NonDeleted<hidewhiteboardBindableElement>)
    : undefined;
...
export const bindOrUnbindBindingElements = (
  selectedArrows: NonDeleted<hidewhiteboardArrowElement>[],
  scene: Scene,
  appState: AppState,
): void => {
...
export const bindBindingElement = (
  arrow: NonDeleted<hidewhiteboardArrowElement>,
  hoveredElement: hidewhiteboardBindableElement,
  mode: BindMode,
  startOrEnd: "start" | "end",
  scene: Scene,
  focusPoint?: GlobalPoint,
...
export const unbindBindingElement = (
  ...
  startOrEnd: "start" | "end",
  scene: Scene,
): hidewhiteboardBindableElement["id"] | null => {
  ...
  if (!oppositeBinding || oppositeBinding.elementId !== binding.elementId) {
    ...
    const boundElement = scene
      ...
      .get(binding.elementId) as hidewhiteboardBindableElement;
...
export const updateBoundElements = (
  changedElement: NonDeletedhidewhiteboardElement,
  scene: Scene,
  options?: {
    simultaneouslyUpdated?: readonly hidewhiteboardElement[];
    changedElements?: Map<string, hidewhiteboardElement>;
  ...
  const visitor = (element: hidewhiteboardElement | undefined) => {
...
const updateArrowBindings = (
  latestElement: hidewhiteboardArrowElement,
  ...
  const bindableElement =
    binding &&
    (elementsMap.get(binding.elementId) as hidewhiteboardBindableElement);
...
export const updateBindings = (
  latestElement: hidewhiteboardElement,
  scene: Scene,
  appState: AppState,
  options?: {
    simultaneouslyUpdated?: readonly hidewhiteboardElement[];
...
const doesNeedUpdate = (
  boundElement: NonDeleted<hidewhiteboardArrowElement>,
  changedElement: hidewhiteboardBindableElement,
) => {
  return (
...
const getSimultaneouslyUpdatedElementIds = (
  simultaneouslyUpdated: readonly hidewhiteboardElement[] | undefined,
): Set<hidewhiteboardElement["id"]> => {
...
export const getHeadingForElbowArrowSnap = (
  ...
  bindableElement: hidewhiteboardBindableElement | undefined | null,
...
const getDistanceForBinding = (
  ...
  bindableElement: hidewhiteboardBindableElement,
  elementsMap: ElementsMap,
  zoom?: AppState["zoom"],
) => {
...
export const bindPointToSnapToElementOutline = (
  arrowElement: hidewhiteboardArrowElement,
  bindableElement: hidewhiteboardBindableElement,
  startOrEnd: "start" | "end",
  elementsMap: ElementsMap,
...
const compareElementArea = (
  a: hidewhiteboardBindableElement,
  b: hidewhiteboardBindableElement,
...
export const updateBoundPoint = (
  ...
  const otherBindableElement =
    otherBinding &&
    (elementsMap.get(otherBinding.elementId)! as hidewhiteboardBindableElement);
...
export const calculateFixedPointForElbowArrowBinding = (
  linearElement: NonDeleted<hidewhiteboardElbowArrowElement>,
  hoveredElement: hidewhiteboardBindableElement,
  startOrEnd: "start" | "end",
  elementsMap: ElementsMap,
...
export const calculateFixedPointForNonElbowArrowBinding = (
  linearElement: NonDeleted<hidewhiteboardArrowElement>,
  hoveredElement: hidewhiteboardBindableElement,
  startOrEnd: "start" | "end",
  elementsMap: ElementsMap,
  focusPoint?: GlobalPoint,
...
export const fixDuplicatedBindingsAfterDuplication = (
  duplicatedElements: hidewhiteboardElement[],
  origIdToDuplicateId: Map<hidewhiteboardElement["id"], hidewhiteboardElement["id"]>,
    ...
    if ("boundElements" in duplicateElement && duplicateElement.boundElements) {
      Object.assign(duplicateElement, {
        boundElements: duplicateElement.boundElements.reduce(
          (
            acc: Mutable<NonNullable<hidewhiteboardElement["boundElements"]>>,
            binding,
          ) => {
...
export const fixBindingsAfterDeletion = (
  sceneElements: readonly hidewhiteboardElement[],
  deletedElements: readonly hidewhiteboardElement[],
): void => {
...
const newBoundElements = (
  boundElements: hidewhiteboardElement["boundElements"],
  idsToRemove: Set<hidewhiteboardElement["id"]>,
  elementsToAdd: Array<hidewhiteboardElement> = [],
) => {
  if (!boundElements) {
    return null;
  }
...
type BoundElementsVisitingFunc = (
  boundElement: hidewhiteboardElement | undefined,
  bindingProp: BindableProp,
  bindingId: string,
) => void;

type BindableElementVisitingFunc<T> = (
  bindableElement: hidewhiteboardElement | undefined,
...
export class BoundElement {
  ...
  public static unbindAffected(
    ...
    boundElement: hidewhiteboardElement | undefined,
    updateElementWith: (
      affected: hidewhiteboardElement,
      updates: ElementUpdate<hidewhiteboardElement>,
    ) => void,
  ) {
    if (!boundElement) {
      return;
        ...
        if (isTextElement(boundElement)) {
          ...
          if (
            ...
            if (boundElement.containerId !== bindableElement.id) {
              ...
              } as ElementUpdate<hidewhiteboardTextElement>);
            }
          } else {
...
export const getGlobalFixedPointForBindableElement = (
  ...
  element: hidewhiteboardBindableElement,
  elementsMap: ElementsMap,
): GlobalPoint => {
...
export const getGlobalFixedPoints = (
  ...
  const startPoint =
    startElement && arrow.startBinding
      ? getGlobalFixedPointForBindableElement(
          arrow.startBinding.fixedPoint,
          startElement as hidewhiteboardBindableElement,
          elementsMap,
        )
      : pointFrom<GlobalPoint>(
  ...
  const endPoint =
    endElement && arrow.endBinding
      ? getGlobalFixedPointForBindableElement(
          arrow.endBinding.fixedPoint,
          endElement as hidewhiteboardBindableElement,
          elementsMap,
        )
      : pointFrom<GlobalPoint>(
...
export const getArrowLocalFixedPoints = (
  arrow: hidewhiteboardElbowArrowElement,
  elementsMap: ElementsMap,
) => {
...
const getShapeType = (element: hidewhiteboardBindableElement): ShapeType => {
...
export const getBindingSideMidPoint = (
  ...
  if (isRectangularElement(bindableElement)) {
    const [sides, corners] = deconstructRectanguloidElement(
      bindableElement as hidewhiteboardRectanguloidElement,
    );
