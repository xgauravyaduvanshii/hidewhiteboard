...
import type { FontString, hidewhiteboardTextElement } from "./types";
 ...
 */
export const detectLineHeight = (textElement: hidewhiteboardTextElement) => {
  const lineCount = splitIntoLines(textElement.text).length;
  return (textElement.height /
    lineCount /
    textElement.fontSize) as hidewhiteboardTextElement["lineHeight"];
};
