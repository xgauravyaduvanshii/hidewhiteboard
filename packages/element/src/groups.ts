...
export const selectGroupsForSelectedElements = (function () {
  ...
  let lastSelectedElements: readonly NonDeleted<hidewhiteboardElement>[] | null =
    null;
  let lastElements: readonly NonDeleted<hidewhiteboardElement>[] | null = null;
  let lastReturnValue: SelectGroupsReturnType | null = null;

  const _selectGroups = (
    selectedElements: readonly NonDeleted<hidewhiteboardElement>[],
    elements: readonly NonDeleted<hidewhiteboardElement>[],
...
export const editGroupForSelectedElement = (
  appState: AppState,
  element: NonDeleted<hidewhiteboardElement>,
): AppState => {
  return {
    ...appState,
...
export const isElementInGroup = (element: hidewhiteboardElement, groupId: string) =>
...
export const getElementsInGroup = (
  ...
  const elementsInGroup: hidewhiteboardElement[] = [];
...
export const addToGroup = (
  prevGroupIds: hidewhiteboardElement["groupIds"],
  newGroupId: GroupId,
  editingGroupId: AppState["editingGroupId"],
) => {
...
export const getMaximumGroups = (
  ...
  const groups: Map<String, hidewhiteboardElement[]> = new Map<
    String,
    hidewhiteboardElement[]
  >();
  elements.forEach((element: hidewhiteboardElement) => {
    const groupId =
...
export const isInGroup = (element: NonDeletedhidewhiteboardElement) => {
...
export const getSelectedElementsByGroup = (
  ...
  const groups: Map<string, hidewhiteboardElement[]> = new Map();
  const elements: Map<string, hidewhiteboardElement[]> = new Map();

  // helper function to add an element to the elements map
  const addToElementsMap = (element: hidewhiteboardElement) => {
    // elements
  ...
  const addToGroupsMap = (element: hidewhiteboardElement, groupId: string) => {
    // groups
    const currentGroupMembers = groups.get(groupId) || [];
    const boundTextElement = getBoundTextElement(element, elementsMap);
