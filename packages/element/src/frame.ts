import { arrayToMap } from "@hidewhiteboard/common";
import { isPointWithinBounds, pointFrom } from "@hidewhiteboard/math";
import { doLineSegmentsIntersect } from "@hidewhiteboard/utils/bbox";
import { elementsOverlappingBBox } from "@hidewhiteboard/utils/withinBounds";
...
import type { ReadonlySetLike } from "@hidewhiteboard/common/utility-types";
...
import type { hidewhiteboardElementsIncludingDeleted } from "./Scene";
...
export const bindElementsToFramesAfterDuplication = (
  ...
  origElements: readonly hidewhiteboardElement[],
...
export function isElementIntersectingFrame(
  ...
  frame: hidewhiteboardFrameLikeElement,
...
export const isCursorInFrame = (
  ...
  frame: NonDeleted<hidewhiteboardFrameLikeElement>,
  elementsMap: ElementsMap,
) => {
 ...
 */
export const groupByFrameLikes = (elements: readonly hidewhiteboardElement[]) => {
...
export const getFrameChildren = (
  ...
  const frameChildren: hidewhiteboardElement[] = [];
...
export const getFrameLikeElements = (
  allElements: hidewhiteboardElementsIncludingDeleted,
): hidewhiteboardFrameLikeElement[] => {
  return allElements.filter((element): element is hidewhiteboardFrameLikeElement =>
    isFrameLikeElement(element),
  );
};

/**
 * Returns hidewhiteboardFrameElements and non-frame-children elements.
 *
...
export const getElementsInResizingFrame = (
  ...
  const nextElementsInFrame = new Set<hidewhiteboardElement>(prevElementsInFrame);
...
export const getElementsInNewFrame = (
  elements: hidewhiteboardElementsIncludingDeleted,
  frame: hidewhiteboardFrameLikeElement,
  elementsMap: ElementsMap,
) => {
...
export const getContainingFrame = (
  ...
  return (elementsMap.get(element.frameId) ||
    null) as null | hidewhiteboardFrameLikeElement;
};
...
export const filterElementsEligibleAsFrameChildren = (
  ...
  const otherFrames = new Set<hidewhiteboardFrameLikeElement["id"]>();
  const elementsMap = arrayToMap(elements);
  ...
  const processedGroups = new Set<hidewhiteboardElement["id"]>();

  const eligibleElements: hidewhiteboardElement[] = [];
...
export const addElementsToFrame = <T extends ElementsMapOrArray>(
  allElements: T,
  elementsToAdd: NonDeletedhidewhiteboardElement[],
  frame: hidewhiteboardFrameLikeElement,
  appState: AppState,
): T => {
  const elementsMap = arrayToMap(allElements);
  const currTargetFrameChildrenMap = new Map<hidewhiteboardElement["id"], true>();
  for (const element of allElements.values()) {
  ...
  const finalElementsToAdd: hidewhiteboardElement[] = [];
...
export const removeElementsFromFrame = (
  elementsToRemove: ReadonlySetLike<NonDeletedhidewhiteboardElement>,
  elementsMap: ElementsMap,
) => {
  ...
  const toRemoveElementsByFrame = new Map<
    hidewhiteboardFrameLikeElement["id"],
    hidewhiteboardElement[]
  >();
...
export const removeAllElementsFromFrame = <T extends hidewhiteboardElement>(
...
export const replaceAllElementsInFrame = <T extends hidewhiteboardElement>(
  allElements: readonly T[],
  nextElementsInFrame: hidewhiteboardElement[],
  frame: hidewhiteboardFrameLikeElement,
...
>(
  ...
  const elementsToFilter = new Set<hidewhiteboardElement>(selectedElements);
  ...
  const elementsToRemove = new Set<hidewhiteboardElement>();
...
export const omitGroupsContainingFrameLikes = (
  ...
  const ret: hidewhiteboardElement[] = [];
...
export const isElementInFrame = (
  ...
  appState: StaticCanvasAppState,
  opts?: {
    targetFrame?: hidewhiteboardFrameLikeElement;
...
export const getDefaultFrameName = (element: hidewhiteboardFrameLikeElement) => {
  // TODO name frames "AI" only if specific to AI frames
  return isFrameElement(element) ? DEFAULT_FRAME_NAME : DEFAULT_AI_FRAME_NAME;
};

export const getFrameLikeTitle = (element: hidewhiteboardFrameLikeElement) => {
