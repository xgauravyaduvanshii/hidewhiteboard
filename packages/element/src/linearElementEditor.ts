...
import { getCurvePathOps } from "@hidewhiteboard/utils/shape";
...
export class LinearElementEditor {
  public readonly elementId: hidewhiteboardElement["id"] & {
    _brand: "hidewhiteboardLinearElementId";
  };
  /** indices */
   ...
   *  statically guarantee this method returns an hidewhiteboardLinearElement)
   */
  static getElement<T extends hidewhiteboardLinearElement>(
  ...
  static handlePointerMove(
    ...
    const startBindingElement =
      ...
      ) as hidewhiteboardBindableElement | null);
  ...
  static handlePointerDown(
    ...
    didAddPoint: boolean;
    hitElement: NonDeleted<hidewhiteboardElement> | null;
   ...
   * of the points.
   */
  static getNormalizeElementPointsAndCoords(element: hidewhiteboardLinearElement) {
  ...
  static deleteFixedSegment(
    element: hidewhiteboardElbowArrowElement,
    scene: Scene,
    index: number,
  ): void {
    scene.mutateElement(element, {
