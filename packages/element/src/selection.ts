import { arrayToMap, isShallowEqual } from "@hidewhiteboard/common";
...
export const getElementsWithinSelection = (
  ...
  selection: NonDeletedhidewhiteboardElement,
...
export const isSomeElementSelected = (function () {
  let lastElements: readonly NonDeletedhidewhiteboardElement[] | null = null;
...
export const getSelectedElements = (
  ...
  const addedElements = new Set<hidewhiteboardElement["id"]>();
  const selectedElements: hidewhiteboardElement[] = [];
  ...
  if (opts?.includeElementsInFrames) {
    const elementsToInclude: hidewhiteboardElement[] = [];
    selectedElements.forEach((element) => {
      if (isFrameLikeElement(element)) {
...
const _getLinearElementEditor = (
  targetElements: readonly hidewhiteboardElement[],
  allElements: readonly NonDeletedhidewhiteboardElement[],
) => {
    ...
    ...selectGroupsForSelectedElements(
      {
        ...
        selectedElementIds: excludeElementsInFramesFromSelection(
          targetElements,
        ).reduce((acc: Record<hidewhiteboardElement["id"], true>, element) => {
