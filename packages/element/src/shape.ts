...
import {
  ...
  getFreedrawShape,
  getPolygonShape,
} from "@hidewhiteboard/utils/shape";
...
import type {
  ...
  ElementShapes,
  SVGPathString,
} from "@hidewhiteboard/hidewhiteboard/scene/types";
...
export class ShapeCache {
   ...
   */
  public static get = <T extends hidewhiteboardElement>(
    element: T,
  ...
  public static delete = (element: hidewhiteboardElement) => {
  ...
  public static generateElementShape = <
    T extends Exclude<hidewhiteboardElement, hidewhiteboardSelectionElement>,
  >(
    element: T,
    renderConfig: {
      isExporting: boolean;
...
function adjustRoughness(element: hidewhiteboardElement): number {
...
const _generateElementShape = (
  element: Exclude<NonDeletedhidewhiteboardElement, hidewhiteboardSelectionElement>,
  generator: RoughGenerator,
  {
    isExporting,
    canvasBackgroundColor,
...
/**
 * get the pure geometric shape of an hidewhiteboard elementw
...
export const toggleLinePolygonState = (
  element: hidewhiteboardLineElement,
  ...
  // TODO: satisfies ElementUpdate<hidewhiteboardLineElement>
  const ret = {
...
const getFreeDrawSvgPath = (element: hidewhiteboardFreeDrawElement) => {
...
export const getFreedrawOutlinePoints = (
  element: hidewhiteboardFreeDrawElement,
) => {
