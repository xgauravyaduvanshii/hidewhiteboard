import { KEYS, invariant, toBrandedType } from "@hidewhiteboard/common";

import { type GlobalPoint, pointFrom, type LocalPoint } from "@hidewhiteboard/math";

import type {
  AppState,
  PendinghidewhiteboardElements,
...
import {
  type ElementsMap,
  type hidewhiteboardBindableElement,
  type hidewhiteboardElement,
  type hidewhiteboardFlowchartNodeElement,
  type NonDeletedSceneElementsMap,
  type Ordered,
  type OrderedhidewhiteboardElement,
} from "./types";
...
const getNodeRelatives = (
  ...
  node: hidewhiteboardBindableElement,
  elementsMap: ElementsMap,
  direction: LinkDirection,
) => {
  const items = [...elementsMap.values()].reduce(
    (acc: { relative: hidewhiteboardBindableElement; heading: Heading }[], el) => {
      let oppositeBinding;
      if (
        isElbowArrow(el) &&
        ...
        invariant(
          ...
          "not an hidewhiteboardBindableElement",
        );
...
const getOffsets = (
  element: hidewhiteboardFlowchartNodeElement,
  linkedNodes: hidewhiteboardElement[],
  direction: LinkDirection,
) => {
...
const addNewNode = (
  ...
  invariant(
    ...
    "not an hidewhiteboardFlowchartNodeElement",
  );
...
export const addNewNodes = (
  startNode: hidewhiteboardFlowchartNodeElement,
  appState: AppState,
  direction: LinkDirection,
  scene: Scene,
  ...
  const newNodes: hidewhiteboardElement[] = [];
...
const createBindingArrow = (
  startBindingElement: hidewhiteboardFlowchartNodeElement,
  endBindingElement: hidewhiteboardFlowchartNodeElement,
  direction: LinkDirection,
  appState: AppState,
  scene: Scene,
) => {
  ...
  const changedElements = new Map<string, OrderedhidewhiteboardElement>();
  changedElements.set(
    startBindingElement.id,
    startBindingElement as OrderedhidewhiteboardElement,
  );
  changedElements.set(
    endBindingElement.id,
    endBindingElement as OrderedhidewhiteboardElement,
  );
  changedElements.set(
    bindingArrow.id,
    bindingArrow as OrderedhidewhiteboardElement,
  );
  ...
  const update = updateElbowArrowPoints(
    ...
    toBrandedType<NonDeletedSceneElementsMap>(
      ...
      ] as [string, Ordered<hidewhiteboardElement>][]),
    ),
...
export class FlowChartNavigator {
  ...
  private sameLevelNodes: hidewhiteboardElement[] = [];
  ...
  private visitedNodes: Set<hidewhiteboardElement["id"]> = new Set();
...
export class FlowChartCreator {
  ...
  pendingNodes: PendinghidewhiteboardElements | null = null;
  ...
  createNodes(
    ...
    if (startNode.frameId) {
      ...
      invariant(
        ...
        "not an hidewhiteboardFrameElement",
      );
