...
import type { AppState, Offsets, Zoom } from "@hidewhiteboard/hidewhiteboard/types";
...
import type { ElementsMap, hidewhiteboardElement } from "./types";
...
export const getNormalizedDimensions = (
  element: Pick<hidewhiteboardElement, "width" | "height" | "x" | "y">,
): {
  width: hidewhiteboardElement["width"];
  height: hidewhiteboardElement["height"];
  x: hidewhiteboardElement["x"];
  y: hidewhiteboardElement["y"];
} => {
  const ret = {
    width: element.width,
