import { pointDistance, pointFrom, type GlobalPoint } from "@hidewhiteboard/math";
import { invariant } from "@hidewhiteboard/common";

import type { AppState, NullableGridSize } from "@hidewhiteboard/hidewhiteboard/types";
...
const focusPointUpdate = (
  arrow: hidewhiteboardArrowElement,
  bindableElement: hidewhiteboardBindableElement | null,
...
export const handleFocusPointPointerUp = (
  ...
  const arrow = LinearElementEditor.getElement<hidewhiteboardArrowElement>(
    linearElementEditor.elementId,
