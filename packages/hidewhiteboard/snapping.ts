...
import { TOOL_TYPE, KEYS } from "@hidewhiteboard/common";
import {
  getCommonBounds,
  getDraggedElementsBounds,
  getElementAbsoluteCoords,
} from "@hidewhiteboard/element";
import { isBoundToContainer } from "@hidewhiteboard/element";

import { getMaximumGroups } from "@hidewhiteboard/element";
...
import type { InclusiveRange } from "@hidewhiteboard/math";
...
export const getVisibleGaps = (
  ...
  const referenceElements: hidewhiteboardElement[] = getReferenceElements(
    elements,
    selectedElements,
    appState,
    elementsMap,
...
export const snapResizingElements = (
  ...
  selectedOriginalElements: hidewhiteboardElement[],
  app: AppClassProperties,
  event: KeyboardModifiersObject,
  dragOffset: Vector2D,
...
export const snapNewElement = (
  newElement: hidewhiteboardElement,
  app: AppClassProperties,
  event: KeyboardModifiersObject,
  origin: Vector2D,
  dragOffset: Vector2D,
