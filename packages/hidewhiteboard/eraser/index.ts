import { arrayToMap, easeOut, THEME } from "@hidewhiteboard/common";
...
import { shouldTestInside } from "@hidewhiteboard/element";
import { hasBoundTextElement, isBoundToContainer } from "@hidewhiteboard/element";
import { getBoundTextElementId } from "@hidewhiteboard/element";

import type { Bounds } from "@hidewhiteboard/common";

import type { GlobalPoint, LineSegment } from "@hidewhiteboard/math/types";
import type { ElementsMap, hidewhiteboardElement } from "@hidewhiteboard/element/types";
...
export class EraserTrail extends AnimatedTrail {
  private elementsToErase: Set<hidewhiteboardElement["id"]> = new Set();
  private groupsToErase: Set<hidewhiteboardElement["id"]> = new Set();
