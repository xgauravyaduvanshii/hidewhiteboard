...
import { getElementLineSegments } from "@hidewhiteboard/element";
...
export class LassoTrail extends AnimatedTrail {
  private intersectedElements: Set<hidewhiteboardElement["id"]> = new Set();
  private enclosedElements: Set<hidewhiteboardElement["id"]> = new Set();
