...
import type { ElementsSegmentsMap, GlobalPoint } from "@hidewhiteboard/math/types";
...
export const getLassoSelectedElementIds = (input: {
  ...
  intersectedElements: Set<hidewhiteboardElement["id"]>;
  enclosedElements: Set<hidewhiteboardElement["id"]>;
