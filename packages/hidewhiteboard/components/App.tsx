...
import {
  ...
  type hidewhiteboardElementSkeleton,
...
} from "@hidewhiteboard/element";

import type { GlobalPoint, LocalPoint, Radians } from "@hidewhiteboard/math";
...
import type { Mutable, ValueOf } from "@hidewhiteboard/common/utility-types";
...
import type { hidewhiteboardLibraryIds } from "../data/types";
...
export const hidewhiteboardContainerContext = React.createContext<{
  container: HTMLDivElement | null;
  id: string | null;
}>({ container: null, id: null });
hidewhiteboardContainerContext.displayName = "hidewhiteboardContainerContext";

const hidewhiteboardElementsContext = React.createContext<
  readonly NonDeletedhidewhiteboardElement[]
>([]);
hidewhiteboardElementsContext.displayName = "hidewhiteboardElementsContext";

const hidewhiteboardAppStateContext = React.createContext<AppState>({
  ...getDefaultAppState(),
  width: 0,
  height: 0,
  offsetLeft: 0,
...
hidewhiteboardAppStateContext.displayName = "hidewhiteboardAppStateContext";

const hidewhiteboardSetAppStateContext = React.createContext<
  React.Component<any, AppState>["setState"]
>(() => {
  console.warn("Uninitialized hidewhiteboardSetAppStateContext context!");
});
hidewhiteboardSetAppStateContext.displayName = "hidewhiteboardSetAppStateContext";

const hidewhiteboardActionManagerContext = React.createContext<ActionManager>(
  null!,
);
hidewhiteboardActionManagerContext.displayName = "hidewhiteboardActionManagerContext";
...
export const usehidewhiteboardContainer = () =>
  useContext(hidewhiteboardContainerContext);
export const usehidewhiteboardElements = () =>
  useContext(hidewhiteboardElementsContext);
export const usehidewhiteboardAppState = () =>
  useContext(hidewhiteboardAppStateContext);
export const usehidewhiteboardSetAppState = () =>
  useContext(hidewhiteboardSetAppStateContext);
export const usehidewhiteboardActionManager = () =>
  useContext(hidewhiteboardActionManagerContext);
...
class App extends React.Component<AppProps, AppState> {
  ...
  private hidewhiteboardContainerRef = React.createRef<HTMLDivElement>();

  public scene: Scene;
  public fonts: Fonts;
  public renderer: Renderer;
  public visibleElements: readonly NonDeletedhidewhiteboardElement[];
  ...
  public hidewhiteboardContainerValue: {
    container: HTMLDivElement | null;
    id: string;
  };
  ...
  private iFrameRefs = new Map<hidewhiteboardElement["id"], HTMLIFrameElement>();
  /**
  ...
  private initializedEmbeds = new Set<hidewhiteboardIframeLikeElement["id"]>();
  ...
  hitLinkElement?: NonDeletedhidewhiteboardElement;
  ...
  constructor(props: AppProps) {
    ...
    if (hidewhiteboardAPI) {
      const api: hidewhiteboardImperativeAPI = {
      ...
      if (typeof hidewhiteboardAPI === "function") {
        hidewhiteboardAPI(api);
      } else {
        console.error("hidewhiteboardAPI should be a function!");
      }
    }

    this.hidewhiteboardContainerValue = {
      container: this.hidewhiteboardContainerRef.current,
      id: this.id,
    };
  ...
  private onWindowMessage(event: MessageEvent) {
    ...
    switch (event.origin) {
      case "https://player.vimeo.com":
        //Allowing for multiple instances of hidewhiteboard running in the window
        if (data.method === "paused") {
          let source: Window | null = null;
          const iframes = document.body.querySelectorAll(
            "iframe.hidewhiteboard__embeddable",
          );
          if (!iframes) {
            break;
          }
  ...
  private previousHoveredBindableElement: NonDeletedhidewhiteboardElement | null =
    null;

  private handleDelayedBindModeChange(
    arrow: hidewhiteboardArrowElement,
    hoveredElement: NonDeletedhidewhiteboardElement | null,
  ) {
  ...
  private cacheEmbeddableRef(
    element: hidewhiteboardIframeLikeElement,
  ...
  private handleEmbeddableCenterClick(element: hidewhiteboardIframeLikeElement) {
    if (
  ...
  private isIframeLikeElementCenter(
    el: hidewhiteboardIframeLikeElement | null,
  ...
  private updateEmbedValidationStatus = (
    element: hidewhiteboardEmbeddableElement,
    status: boolean,
  ) => {
  ...
  private updateEmbeddables = () => {
    const iframeLikes = new Set<hidewhiteboardIframeLikeElement["id"]>();
  ...
  private renderEmbeddables() {
    ...
    const embeddableElements = this.scene
      ...
      .filter(
        (el): el is Ordered<NonDeleted<hidewhiteboardIframeLikeElement>> =>
      ...
      <>
        {embeddableElements.map((el) => {
          ...
          return (
            <div
              key={el.id}
              className={clsx("hidewhiteboard__embeddable-container", {
            ...
            >
              <div
                //this is a hack that addresses isse with embedded hidewhiteboard.com embeddable
                //https://github.com/xgauravyaduvanshii/hidewhiteboard/pull/6691#issuecomment-1607383938
                /*ref={(ref) => {
                  if (!this.hidewhiteboardContainerRef.current) {
                    return;
                  }
                  const container = this.hidewhiteboardContainerRef.current;
                ...
                className="hidewhiteboard__embeddable-container__inner"
                style={{
              ...
              >
                {isHovered && (
                  <div className="hidewhiteboard__embeddable-hint">
                    {t("buttons.embeddableInteractionButton")}
                  </div>
                )}
                <div
                  className="hidewhiteboard__embeddable__outer"
                  style={{
                ...
                >
                  {(isEmbeddableElement(el)
                    ...
                    <iframe
                      ...
                      className="hidewhiteboard__embeddable"
                      srcDoc={
                        src?.type === "document"
                      ...
                      title="hidewhiteboard Embedded Content"
  ...
  private getFrameNameDOMId = (frameElement: hidewhiteboardElement) => {
  ...
  private resetEditingFrame = (frame: hidewhiteboardFrameLikeElement | null) => {
    if (frame) {
  ...
  public render() {
    ...
    return (
      <div
        translate="no"
        className={clsx("hidewhiteboard hidewhiteboard-container notranslate", {
          "hidewhiteboard--view-mode":
            this.state.viewModeEnabled ||
            this.state.openDialog?.name === "elementLinkSelector",
          "hidewhiteboard--mobile": this.editorInterface.formFactor === "phone",
        })}
        style={{
        ...
        ref={this.hidewhiteboardContainerRef}
      ...
      >
        <AppContext.Provider value={this}>
          <AppPropsContext.Provider value={this.props}>
            <hidewhiteboardContainerContext.Provider
              value={this.hidewhiteboardContainerValue}
            >
              <EditorInterfaceContext.Provider value={this.editorInterface}>
                <hidewhiteboardSetAppStateContext.Provider value={this.setAppState}>
                  <hidewhiteboardAppStateContext.Provider value={this.state}>
                    <hidewhiteboardElementsContext.Provider
                      value={this.scene.getNonDeletedElements()}
                    >
                      <hidewhiteboardActionManagerContext.Provider
                      ...
                      >
                        ...
                        <div className="hidewhiteboard-textEditorContainer" />
                        <div className="hidewhiteboard-contextMenuContainer" />
                        <div className="hidewhiteboard-eye-dropper-container" />
                        <SVGLayer
                          trails={[
                            this.laserTrails,
                            this.lassoTrail,
                        ...
                        <InteractiveCanvas
                          app={this}
                          containerRef={this.hidewhiteboardContainerRef}
                  ...
                  </hidewhiteboardAppStateContext.Provider>
                </hidewhiteboardSetAppStateContext.Provider>
  ...
  public focusContainer: AppClassProperties["focusContainer"] = () => {
    this.hidewhiteboardContainerRef.current?.focus();
  };
  ...
  public onInsertElements = (elements: readonly hidewhiteboardElement[]) => {
  ...
  public onExportImage = async (
    ...
    opts: { exportingFrame: hidewhiteboardFrameLikeElement | null },
  ) => {
  ...
  private magicGenerations = new Map<
    hidewhiteboardIframeElement["id"],
    MagicGenerationData
  >();
  ...
  private updateMagicGeneration = ({
    ...
    frameElement: hidewhiteboardIframeElement;
  ...
  private async onMagicFrameGenerate(
    magicFrame: hidewhiteboardMagicFrameElement,
  ...
  private onIframeSrcCopy(element: hidewhiteboardIframeElement) {
  ...
  public onMagicframeToolSelect = () => {
    ...
    if (selectedElements.length === 0) {
      ...
      const selectedMagicFrame: hidewhiteboardMagicFrameElement | false =
        selectedElements.length === 1 &&
      ...
      let frame: hidewhiteboardMagicFrameElement;
  ...
  public async componentDidMount() {
    ...
    this.hidewhiteboardContainerValue.container =
      this.hidewhiteboardContainerRef.current;
    ...
    if (this.props.autoFocus && this.hidewhiteboardContainerRef.current) {
      this.focusContainer();
    }

    if (supportsResizeObserver && this.hidewhiteboardContainerRef.current) {
      this.resizeObserver = new ResizeObserver(() => {
        this.refreshEditorInterface();
        this.updateDOMRect();
      });
      this.resizeObserver?.observe(this.hidewhiteboardContainerRef.current);
    }
  ...
  private addEventListeners() {
    ...
    if (this.props.detectScroll) {
      this.onRemoveEventListenersEmitter.once(
        addEventListener(
          getNearestScrollableContainer(this.hidewhiteboardContainerRef.current!),
          EVENT.SCROLL,
          this.onScroll,
          { passive: false },
        ),
  ...
  componentDidUpdate(prevProps: AppProps, prevState: AppState) {
    ...
    this.hidewhiteboardContainerRef.current?.classList.toggle(
      "theme--dark",
  ...
  private onCut = withBatchedUpdates((event: ClipboardEvent) => {
    const ishidewhiteboardActive = this.hidewhiteboardContainerRef.current?.contains(
      document.activeElement,
    );
    if (!ishidewhiteboardActive || isWritableElement(event.target)) {
      return;
    }
  ...
  private async insertClipboardContent(
    ...
    if (data.elements) {
      const elements = (
        data.programmaticAPI
          ? convertTohidewhiteboardElements(
              data.elements as hidewhiteboardElementSkeleton[],
            )
          : data.elements
      ) as readonly hidewhiteboardElement[];
    ...
    if (!isPlainPaste && isMaybeMermaidDefinition(data.text)) {
      ...
      try {
        const { elements: skeletonElements, files } =
          await parseMermaidToExcalidraw(data.text);

        const elements = convertTohidewhiteboardElements(skeletonElements, {
          regenerateIds: true,
        });
    ...
    if (
      ...
      const embeddables: NonDeleted<hidewhiteboardEmbeddableElement>[] = [];
      for (const url of embbeddableUrls) {
        const prevEmbeddable: hidewhiteboardEmbeddableElement | undefined =
  ...
  public pasteFromClipboard = withBatchedUpdates(
    async (event: ClipboardEvent) => {
      ...
      const ishidewhiteboardActive =
        this.hidewhiteboardContainerRef.current?.contains(target);
      if (event && !ishidewhiteboardActive) {
        return;
      }
        ...
        ...selectGroupsForSelectedElements(
          {
            ...
            selectedElementIds: nextElementsToSelect.reduce(
              (acc: Record<hidewhiteboardElement["id"], true>, element) => {
  ...
  private addTextFromPaste(text: string, isPlainPaste = false) {
    ...
    const textElements = lines.reduce(
      (acc: hidewhiteboardTextElement[], line, idx) => {
  ...
  scrollToContent = (
     ...
     * - hidewhiteboardElement | hidewhiteboardElement[] - element(s) objects
     */
    target:
      | string
      | hidewhiteboardElement
      | readonly hidewhiteboardElement[] = this.scene.getNonDeletedElements(),
    opts?: (
      | {
          fitToContent?: boolean;
          fitToViewport?: never;
    ...
    // convert provided target into hidewhiteboardElement[] if necessary
   ...
   * */
  public addFiles: hidewhiteboardImperativeAPI["addFiles"] = withBatchedUpdates(
    (files) => {
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
       ...
       *
       * Check [API docs](https://github.com/xgauravyaduvanshii/hidewhiteboard/docs/@hidewhiteboard/hidewhiteboard/api/props/hidewhiteboard-api#captureUpdate) for more details.
       *
  ...
  public mutateElement = <TElement extends Mutable<hidewhiteboardElement>>(
    element: TElement,
  ...
  public getEditorUIOffsets = (): Offsets => {
    ...
    const sidebarRect = this.hidewhiteboardContainerRef?.current
      ?.querySelector(".sidebar")
      ?.getBoundingClientRect();
    const propertiesPanelRect = this.hidewhiteboardContainerRef?.current
    ...
    (event: React.KeyboardEvent | KeyboardEvent) => {
      ...
      if (!isInputLike(event.target)) {
        ...
        if (event.key === KEYS.ESCAPE) {
          ...
          event.key === KEYS.TAB &&
          (document.activeElement === this.hidewhiteboardContainerRef?.current ||
      ...
      if (isArrowKey(event.key)) {
        ...
        selectedElements
          .filter((el): el is NonDeleted<hidewhiteboardArrowElement> =>
            isBindingElement(el),
          )
          .filter((arrow) => {
        ...
        if (selectedElements.length === 1) {
          ...
          if (event[KEYS.CTRL_OR_CMD] || isLineElement(selectedElement)) {
            ...
            if (!isTextElement(selectedElement)) {
              container = selectedElement as hidewhiteboardTextContainer;
            }
            ...
            this.scene.mutateElement(element, {
              startBinding: {
                ...
                ...calculateFixedPointForNonElbowArrowBinding(
                  ...
                  ) as hidewhiteboardBindableElement,
                  "start",
                  elementsMap,
                ),
              },
  ...
  private handleTextWysiwyg(
    element: hidewhiteboardTextElement,
    {
    ...
    textWysiwyg({
      ...
      element,
      hidewhiteboardContainer: this.hidewhiteboardContainerRef.current,
      app: this,
  ...
  private getTextElementAtPosition(
    x: number,
    y: number,
  ): NonDeleted<hidewhiteboardTextElement> | null {
  ...
  private getElementAtPosition(
    ...
    opts?: (
      ...
      | {
          allHitElements: NonDeleted<hidewhiteboardElement>[];
        }
    ) & {
      preferSelected?: boolean;
    },
  ): NonDeleted<hidewhiteboardElement> | null {
    let allHitElements: NonDeleted<hidewhiteboardElement>[] = [];
  ...
  private getElementsAtPosition(
  ...
  ): NonDeleted<hidewhiteboardElement>[] {
    const iframeLikes: Ordered<hidewhiteboardIframeElement>[] = [];
    ...
    const elements = (
      ...
      .concat(iframeLikes) as NonDeleted<hidewhiteboardElement>[];

    return elements;
  }

  getElementHitThreshold(element: hidewhiteboardElement) {
    return Math.max(
  ...
  private startTextEditing = ({
    ...
    container?: hidewhiteboardTextContainer | null;
    autoEdit?: boolean;
  }) => {
    ...
    let existingTextElement: NonDeleted<hidewhiteboardTextElement> | null = null;
  ...
  private startImageCropping = (image: hidewhiteboardImageElement) => {
    this.store.scheduleCapture();
    this.setState({
  ...
  private handleCanvasDoubleClick = (
    ...
    if (selectedElements.length === 1 && isLinearElement(selectedElements[0])) {
      const selectedLinearElement: hidewhiteboardLinearElement =
        selectedElements[0];
      if (
  ...
  private getElementLinkAtPosition = (
    ...
    hitElementMightBeLocked: NonDeletedhidewhiteboardElement | null,
  ): hidewhiteboardElement | undefined => {
    ...
    if (lastPointerDownHittingLinkIcon && lastPointerUpHittingLinkIcon) {
      ...
      if (url) {
        ...
        if (this.props.onLinkOpen) {
          customEvent = wrapEvent(EVENT.HIDEWHITEBOARD_LINK, event.nativeEvent);
  ...
  private getTopLayerFrameAtSceneCoords = (sceneCoords: {
    ...
    const frames = this.scene
      ...
      .filter(
        (frame): frame is hidewhiteboardFrameLikeElement =>
  ...
  private handleCanvasPointerMove = (
    ...
    if (
      ...
      if (
        ...
        // update the state. Check https://github.com/xgauravyaduvanshii/hidewhiteboard/pull/5508 for more details.
        flushSync(() => {
          this.setState({
    ...
    let hitElement: hidewhiteboardElement | null = null;
    if (hitElementMightBeLocked && hitElementMightBeLocked.locked) {
      hitElement = null;
    } else {
    ...
    if (this.state.selectedLinearElement) {
      ...
      if (arrow.startBinding || arrow.endBinding) {
        hoveredFocusPointBinding = handleFocusPointHover(
          element as hidewhiteboardArrowElement,
          scenePointerX,
          scenePointerY,
          this.scene,
          this.state,
  ...
  private handleCanvasPointerDown = (
    ...
    if (
      ...
      const element = this.state.newElement as hidewhiteboardFreeDrawElement;
      this.updateScene({
    ...
    if (this.state.activeTool.type === "lasso") {
      ...
      if (
        ...
        this.setState((prevState) => {
          ...
          const previouslySelectedElements: hidewhiteboardElement[] = [];
  ...
  public handleCanvasPanUsingWheelOrSpaceDrag = (
    ...
    if (!this.state.editingTextElement) {
      // necessary to prevent browser from scrolling the page if hidewhiteboard
      // not full-page #4489
      //
  ...
  private isASelectedElement(hitElement: hidewhiteboardElement | null): boolean {
    return hitElement != null && this.state.selectedElementIds[hitElement.id];
  }

  private isHittingCommonBoundingBoxOfSelectedElements(
    point: Readonly<{ x: number; y: number }>,
    selectedElements: readonly hidewhiteboardElement[],
  ): boolean {
  ...
  private handleTextOnPointerDown = (
    ...
    if (hasBoundTextElement(element)) {
      container = element as hidewhiteboardTextContainer;
  ...
  private handleFreeDrawElementOnPointerDown = (
    event: React.PointerEvent<HTMLElement>,
    elementType: hidewhiteboardFreeDrawElement["type"],
    pointerDownState: PointerDownState,
  ) => {
  ...
  private handleLinearElementOnPointerDown = (
    event: React.PointerEvent<HTMLElement>,
    elementType: hidewhiteboardLinearElement["type"],
    pointerDownState: PointerDownState,
  ): void => {
    if (event.ctrlKey) {
      flushSync(() => {
  ...
  private createGenericElementOnPointerDown = (
    elementType: hidewhiteboardGenericElement["type"] | "embeddable",
    pointerDownState: PointerDownState,
  ): void => {
    const [gridX, gridY] = getGridPoint(
      pointerDownState.origin.x,
  ...
  private maybeCacheReferenceSnapPoints(
    ...
    selectedElements: hidewhiteboardElement[],
  ...
  private onKeyUpFromPointerDownHandler(
    ...
    return withBatchedUpdates((event: KeyboardEvent) => {
      // Prevents focus from escaping hidewhiteboard tab
    ...
    return withBatchedUpdates((childEvent: PointerEvent) => {
      ...
      if (
        ...
        if (this.state.selectedLinearElement.elbowed) {
          ...
          if (element) {
            this.scene.mutateElement(
              element as hidewhiteboardElbowArrowElement,
              {},
            );
          }
        }
      ...
      if (pointerDownState.drag.hasOccurred) {
        ...
        if (
          ...
          const updateGroupIdsAfterEditingGroup = (
            elements: hidewhiteboardElement[],
          ) => {
      ...
      if (pointerDownState.resize.isResizing) {
        ...
        const selectedFrames = this.scene
          .getSelectedElements(this.state)
          .filter((element): element is hidewhiteboardFrameLikeElement =>
  ...
  private initializeImage = async (
    placeholderImageElement: hidewhiteboardImageElement,
    imageFile: File,
  ) => {
    ...
    return new Promise<NonDeleted<InitializedhidewhiteboardImageElement>>(
  ...
  private getLatestInitializedImageElement = (
    imagePlaceholder: hidewhiteboardImageElement,
    fileId: FileId,
  ) => {
    ...
    return newElementWith(
      latestImageElement as InitializedhidewhiteboardImageElement,
      {
        fileId,
      },
    );
  ...
  private getImageNaturalDimensions = (
    imageElement: hidewhiteboardImageElement,
  ...
  private updateImageCache = async (
    elements: readonly InitializedhidewhiteboardImageElement[],
    files = this.files,
  ) => {
  ...
  private addNewImagesToImageCache = async (
    imageElements: InitializedhidewhiteboardImageElement[] = getInitializedImageElements(
      this.scene.getNonDeletedElements(),
    ),
  ...
  private clearSelection(hitElement: hidewhiteboardElement | null): void {
    this.setState((prevState) => ({
      selectedElementIds: makeNextSelectedElementIds({}, prevState),
      activeEmbeddable: null,
      selectedGroupIds: {},
  ...
  private handleAppOnDrop = async (event: React.DragEvent<HTMLDivElement>) => {
    ...
    const hidewhiteboardLibrary_ids = dataTransferList.getData(
      MIME_TYPES.hidewhiteboardlibIds,
    );
    const hidewhiteboardLibrary_data = dataTransferList.getData(
      MIME_TYPES.hidewhiteboardlib,
    );
    if (hidewhiteboardLibrary_ids || hidewhiteboardLibrary_data) {
      try {
        let libraryItems: LibraryItems | null = null;
        if (hidewhiteboardLibrary_ids) {
          const { itemIds } = JSON.parse(
            hidewhiteboardLibrary_ids,
          ) as hidewhiteboardLibraryIds;
        ...
        } else if (hidewhiteboardLibrary_data) {
          libraryItems = parseLibraryJSON(hidewhiteboardLibrary_data);
        }
    ...
    if (fileItems.length > 0) {
      const { file, fileHandle } = fileItems[0];
      if (file) {
        // Attempt to parse an hidewhiteboard/hidewhiteboardlib file
  ...
  loadFileToCanvas = async (
    ...
    try {
      ...
      if (ret.type === MIME_TYPES.hidewhiteboard) {
      ...
      } else if (ret.type === MIME_TYPES.hidewhiteboardlib) {
        await this.library
          .updateLibrary({
            libraryItems: file,
            merge: true,
    ...
    if (
      ...
      this.setState({
        elementsToHighlight: getElementsInResizingFrame(
          this.scene.getNonDeletedElements(),
          newElement as hidewhiteboardFrameLikeElement,
          this.state,
          this.scene.getNonDeletedElementsMap(),
        ),
      });
  ...
  private maybeHandleResize = (
    ...
    const selectedFrames = selectedElements.filter(
      (element): element is hidewhiteboardFrameLikeElement =>
        isFrameLikeElement(element),
    );
    ...
    if (
      ...
      const elementsToHighlight = new Set<hidewhiteboardElement>();
      selectedFrames.forEach((frame) => {
        getElementsInResizingFrame(
          this.scene.getNonDeletedElements(),
          frame,
  ...
  private updateDOMRect = (cb?: () => void) => {
    if (this.hidewhiteboardContainerRef?.current) {
      const hidewhiteboardContainer = this.hidewhiteboardContainerRef.current;
      const {
        width,
        height,
        left: offsetLeft,
        top: offsetTop,
      } = hidewhiteboardContainer.getBoundingClientRect();
      const {
        width: currentWidth,
  ...
  private getCanvasOffsets(): Pick<AppState, "offsetTop" | "offsetLeft"> {
    if (this.hidewhiteboardContainerRef?.current) {
      const hidewhiteboardContainer = this.hidewhiteboardContainerRef.current;
      const { left, top } = hidewhiteboardContainer.getBoundingClientRect();
      return {
        offsetLeft: left,
        offsetTop: top,
      };
  ...
  if (isTestEnv() || isDevEnv()) {
    ...
    Object.defineProperties(window.h, {
      elements: {
        ...
        set(elements: hidewhiteboardElement[]) {
