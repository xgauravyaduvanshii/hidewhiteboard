import { round } from "@hidewhiteboard/math";
import clsx from "clsx";
import throttle from "lodash.throttle";
import { useEffect, useMemo, useState, memo } from "react";

import { STATS_PANELS } from "@hidewhiteboard/common";
import { getCommonBounds } from "@hidewhiteboard/element";
import { getUncroppedWidthAndHeight } from "@hidewhiteboard/element";
import { isImageElement } from "@hidewhiteboard/element";

import { frameAndChildrenSelectedTogether } from "@hidewhiteboard/element";

import { elementsAreInSameGroup } from "@hidewhiteboard/element";

import type { NonDeletedhidewhiteboardElement } from "@hidewhiteboard/element/types";

import { t } from "../../i18n";
import { isGridModeEnabled } from "../../snapping";
import { usehidewhiteboardAppState, usehidewhiteboardSetAppState } from "../App";
...
interface StatsProps {
  ...
  onClose: () => void;
  renderCustomStats: hidewhiteboardProps["renderCustomStats"];
}
...
export const StatsInner = memo(
  ({
    ...
    const throttledSetSceneDimension = useMemo(
      () =>
        throttle((elements: readonly NonDeletedhidewhiteboardElement[]) => {
