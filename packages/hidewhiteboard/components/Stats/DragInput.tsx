...
import { EVENT, KEYS, cloneJSON } from "@hidewhiteboard/common";
...
import { useApp, usehidewhiteboardSetAppState } from "../App";
...
> = (props: {
  ...
  setAppState: ReturnType<typeof usehidewhiteboardSetAppState>;
}) => void;

export type DragFinishedCallbackType<E = hidewhiteboardElement> = (props: {
  app: ReturnType<typeof useApp>;
  setAppState: ReturnType<typeof usehidewhiteboardSetAppState>;
...
const StatsDragInput = <
  T extends StatsInputProperty,
  E extends hidewhiteboardElement = hidewhiteboardElement,
>({
  label,
  icon,
  dragInputCallback,
      ...
      <div
        ...
        onPointerDown={(event) => {
          if (inputRef.current && editable) {
            document.body.classList.add("hidewhiteboard-cursor-resize");
            ...
            const onPointerUp = () => {
              ...
              document.body.classList.remove("hidewhiteboard-cursor-resize");
