import { degreesToRadians, pointFrom, pointRotateRads } from "@hidewhiteboard/math";
import { act, fireEvent, queryByTestId } from "@testing-library/react";
import React from "react";
import { vi } from "vitest";

import { setDateTimeForTests, reseed } from "@hidewhiteboard/common";

import { isInGroup } from "@hidewhiteboard/element";

import { isTextElement } from "@hidewhiteboard/element";

import type { Degrees } from "@hidewhiteboard/math";
...
import { Hidewhiteboard, getCommonBounds } from "../../index";
...
describe("binding with linear elements", () => {
  ...
  it("should remain bound to linear element on small position change", async () => {
    const linear = h.elements[1] as hidewhiteboardLinearElement;
...
describe("stats for a non-generic element", () => {
  ...
  it("text element", async () => {
    ...
    const text = h.elements[0] as hidewhiteboardTextElement;
    mouse.clickOn(text);
