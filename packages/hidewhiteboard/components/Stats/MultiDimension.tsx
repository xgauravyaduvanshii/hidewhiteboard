...
import { MIN_WIDTH_OR_HEIGHT } from "@hidewhiteboard/common";
import {
...
import { getBoundTextElement, handleBindTextResize } from "@hidewhiteboard/element";

import { isTextElement } from "@hidewhiteboard/element";

import { getCommonBounds } from "@hidewhiteboard/utils";
...
const resizeGroup = (
  ...
  anchor: GlobalPoint,
  property: MultiDimensionProps["property"],
  latestElements: hidewhiteboardElement[],
  originalElements: hidewhiteboardElement[],
  originalElementsMap: ElementsMap,
  scene: Scene,
) => {
...
> = ({
  ...
  const elementsToHighlight: hidewhiteboardElement[] = [];
