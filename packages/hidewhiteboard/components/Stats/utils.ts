...
import { DRAGGING_THRESHOLD } from "@hidewhiteboard/common";
...
export const isPropertyEditable = (
  ...
  property: keyof hidewhiteboardElement,
) => {
...
export const getElementsInAtomicUnit = (
  ...
  return Object.keys(atomicUnit)
    ...
    original: NonDeletedhidewhiteboardElement;
...
export const moveElement = (
  newTopLeftX: number,
  newTopLeftY: number,
  originalElement: hidewhiteboardElement,
  scene: Scene,
  appState: AppState,
  originalElementsMap: ElementsMap,
