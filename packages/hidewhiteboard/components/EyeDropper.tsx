...
import { EVENT, KEYS, rgbToHex } from "@hidewhiteboard/common";
...
import { useApp, usehidewhiteboardContainer, usehidewhiteboardElements } from "./App";
...
export const EyeDropper: React.FC<{
  ...
  const eyeDropperContainer = useCreatePortalContainer({
    className: "hidewhiteboard-eye-dropper-backdrop",
    parentSelector: ".hidewhiteboard-eye-dropper-container",
  });
  const appState = useUIAppState();
  const elements = usehidewhiteboardElements();
  const app = useApp();
    ...
    (event) => {
      if (
        event.target.closest(
          ".hidewhiteboard-eye-dropper-trigger, .hidewhiteboard-eye-dropper-backdrop",
        )
      ) {
        return true;
      }
  ...
  return createPortal(
    <div ref={ref} className="hidewhiteboard-eye-dropper-preview" />,
    eyeDropperContainer,
  );
};
