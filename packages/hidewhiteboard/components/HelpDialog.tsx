...
import { isDarwin, isFirefox, isWindows } from "@hidewhiteboard/common";
...
const Header = () => (
  <div className="HelpDialog__header">
    <a
      ...
      href="mailto:xgauravyaduvanshii@gmail.com"
      target="_blank"
    ...
    <div className="HelpDialog__btn">
      <div className="HelpDialog__link-icon">{ExternalLinkIcon}</div>
      Author: xgauravyaduvanshii
    </div>
  </div>
);
