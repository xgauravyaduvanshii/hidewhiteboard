...
import { isShallowEqual } from "@hidewhiteboard/common";
...
const StaticCanvas = (props: StaticCanvasProps) => {
  ...
  useEffect(() => {
    ...
    if (!isComponentMounted.current) {
      ...
      canvas.classList.add("hidewhiteboard__canvas", "static");
    }
  ...
  return <div className="hidewhiteboard__canvas-wrapper" ref={wrapperRef} />;
};
