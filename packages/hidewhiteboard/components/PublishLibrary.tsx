import { exportToCanvas, exportToSvg } from "@hidewhiteboard/utils/export";
...
const PublishLibrary = ({
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("hidewhiteboardLib", lib);
        ...
        <form onSubmit={onSubmit}>
          <div className="publish-library-note">
            <Trans
              ...
              link={(el) => (
                <a
                  href="https://libraries.hidewhiteboard.com"
                  target="_blank"
                  rel="noopener"
                >
                  {el}
          ...
          <span className="publish-library-note">
            <Trans
              ...
              link={(el) => (
                <a
                  href="https://github.com/xgauravyaduvanshii/hidewhiteboard#guidelines"
                  target="_blank"
          ...
          <div className="publish-library__fields">
            ...
            <span className="publish-library-note">
              <Trans
                ...
                link={(el) => (
                  <a
                    href="https://github.com/xgauravyaduvanshii/hidewhiteboard"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {el}
