...
import { DiscordIcon, XBrandIcon, settingsIcon } from "../icons";
import {
  boltIcon,
  DeviceDesktopIcon,
  ExportIcon,
...
export const Preferences = ({
  ...
  return (
    <DropdownMenuSub>
      ...
      <DropdownMenuSub.Content className="hidewhiteboard-main-menu-preferences-submenu">
        {children || (
          <>
