...
import { EDITOR_LS_KEYS, debounce, isDevEnv } from "@hidewhiteboard/common";
...
import {
  convertMermaidTohidewhiteboard,
  insertToEditor,
  saveMermaidDataToStorage,
  resetPreview,
} from "./common";

import "./MermaidTohidewhiteboard.scss";
...
const MermaidTohidewhiteboard = ({
  ...
  const [text, setText] = useState(
    () =>
      EditorLocalStorage.get<string>(EDITOR_LS_KEYS.MERMAID_TO_HIDEWHITEBOARD) ||
      MERMAID_EXAMPLE,
  );
  ...
  useEffect(() => {
    const doRender = async () => {
      try {
        ...
        const result = await convertMermaidTohidewhiteboard({
          canvasRef,
          data,
          mermaidTohidewhiteboardLib,
          setError,
  ...
  }, [deferredText, mermaidTohidewhiteboardLib, isActive, theme]);
    ...
    <>
      ...
      <TTDDialogPanels>
        ...
        >
          <TTDDialogOutput
            canvasRef={canvasRef}
            loaded={mermaidTohidewhiteboardLib.loaded}
            error={error}
          />
        </TTDDialogPanel>
      </TTDDialogPanels>
...
export default MermaidTohidewhiteboard;
