...
import { parseMermaidToExcalidraw as parseMermaidTohidewhiteboard } from "@hidewhiteboard/mermaid-to-hidewhiteboard";
import { isFiniteNumber } from "@hidewhiteboard/math";
...
export const useTextGeneration = ({
  ...
  const onGenerate: TTTDDialog.OnGenerate = async ({
    ...
    try {
      ...
      try {
        await parseMermaidTohidewhiteboard(generatedResponse ?? "");
