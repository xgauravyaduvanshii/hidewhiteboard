...
import { MIME_TYPES, arrayToMap, nextAnimationFrame } from "@hidewhiteboard/common";

import { duplicateElements } from "@hidewhiteboard/element";
...
export default function LibraryMenuItems({
  ...
  const onItemDrag = useCallback(
    (id: LibraryItem["id"], event: React.DragEvent) => {
      ...
      const data: hidewhiteboardLibraryIds = {
