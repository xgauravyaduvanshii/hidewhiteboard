...
import { useEditorInterface, usehidewhiteboardActionManager } from "../App";
import { hidewhiteboardLogo as HidewhiteboardLogo } from "../hidewhiteboardLogo";
...
const Logo = ({ children }: { children?: React.ReactNode }) => {
  return (
    <div className="welcome-screen-center__logo excalifont welcome-screen-decor">
      {children || <HidewhiteboardLogo withText />}
    </div>
  );
};
