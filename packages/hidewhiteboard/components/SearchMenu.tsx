...
import { isElementCompletelyInViewport } from "@hidewhiteboard/element";
...
import { isTextElement, isFrameLikeElement } from "@hidewhiteboard/element";

import { getDefaultFrameName } from "@hidewhiteboard/element/frame";
...
type SearchMatchItem = {
  element: hidewhiteboardTextElement | hidewhiteboardFrameLikeElement;
...
const handleSearch = debounce(
  (
    ...
    ) as hidewhiteboardFrameLikeElement[];
