import type { UserIdleState, EditorInterface } from "@hidewhiteboard/common";
import type {
...
export type StaticCanvasRenderConfig = {
  ...
  pendingFlowchartNodes: PendinghidewhiteboardElements | null;
...
export type InteractiveCanvasRenderConfig = {
  ...
  // ---------------------------------------------------------------------------
  remoteSelectedElementIds: Map<hidewhiteboardElement["id"], SocketId[]>;
...
export type StaticSceneRenderConfig = {
  ...
  visibleElements: readonly NonDeletedhidewhiteboardElement[];
  scale: number;
...
export type NewElementSceneRenderConfig = {
  canvas: HTMLCanvasElement | null;
  rc: RoughCanvas;
  newElement: hidewhiteboardElement | null;
  elementsMap: RenderableElementsMap;
  allElementsMap: NonDeletedSceneElementsMap;
  scale: number;
  appState: AppState;
