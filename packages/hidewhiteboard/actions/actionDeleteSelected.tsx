...
import { fixBindingsAfterDeletion } from "@hidewhiteboard/element";
...
const deleteSelectedElements = (
  ...
  const selectedElementIds: Record<hidewhiteboardElement["id"], true> = {};

  const elementsMap = app.scene.getNonDeletedElementsMap();

  const processedElements = new Set<hidewhiteboardElement["id"]>();
