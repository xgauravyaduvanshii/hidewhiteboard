...
import { arrayToMap, invariant } from "@hidewhiteboard/common";
...
export const actionToggleLinearEditor = register({
  ...
  label: (elements, appState, app) => {
    ...
    })[0] as hidewhiteboardLinearElement | undefined;
...
export const actionTogglePolygon = register({
  ...
  perform(elements, appState, _, app) {
    ...
    const targetElements = selectedElements as hidewhiteboardLineElement[];
