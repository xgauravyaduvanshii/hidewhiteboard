...
import { syncMovedIndices } from "@hidewhiteboard/element";

import { newElement } from "@hidewhiteboard/element";
  ...
  perform: (elements, appState, _, app) => {
    ...
    selectedElements.forEach((element) => {
      ...
      if (boundTextElement) {
        ...
        app.scene.mutateElement(boundTextElement as hidewhiteboardTextElement, {
          containerId: null,
          width,
          height,
...
export const actionBindText = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    let container: hidewhiteboardTextContainer;
    ...
    if (
      ...
      textElement = selectedElements[1] as hidewhiteboardTextElement;
      container = selectedElements[0] as hidewhiteboardTextContainer;
    }
...
export const actionWrapTextInContainer = register({
  ...
  perform: (elements, appState, _, app) => {
    const selectedElements = app.scene.getSelectedElements(appState);
    let updatedElements: readonly hidewhiteboardElement[] = elements.slice();
