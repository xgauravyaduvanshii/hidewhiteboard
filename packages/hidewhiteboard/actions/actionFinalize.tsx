...
import { bindOrUnbindBindingElement } from "@hidewhiteboard/element/binding";
import {
  isValidPolygon,
  LinearElementEditor,
  newElementWith,
...
import { isPathALoop } from "@hidewhiteboard/element";
...
export const actionFinalize = register<FormData>({
  ...
  perform: (elements, appState, data, app) => {
    ...
    let element: NonDeleted<hidewhiteboardElement> | null = null;
    if (appState.multiElement) {
      ...
      ) as NonDeleted<hidewhiteboardLinearElement> | undefined;
      if (candidate) {
        element = candidate;
      }
    }
