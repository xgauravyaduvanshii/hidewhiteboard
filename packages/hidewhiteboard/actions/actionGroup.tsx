...
import { KEYS, randomId, arrayToMap } from "@hidewhiteboard/common";
...
const allElementsInSameGroup = (elements: readonly hidewhiteboardElement[]) => {
...
export const actionGroup = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    const lastGroupElementIndex = nextElements.lastIndexOf(
      lastElementInGroup as OrderedhidewhiteboardElement,
    );
...
export const actionUngroup = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    const boundTextElementIds: hidewhiteboardTextElement["id"][] = [];
    nextElements = nextElements.map((element) => {
    ...
    updateAppState.selectedElementIds = Object.entries(
      ...
      (acc: { [key: hidewhiteboardElement["id"]]: true }, [id, selected]) => {
