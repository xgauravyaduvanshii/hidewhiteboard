...
copyright: Copyright (c) 2024 by hidewhiteboard. All rights reserved.
...
trademark: Excalifont is a trademark of hidewhiteboard.
...
export const ExcalifontFontFaces: hidewhiteboardFontFaceDescriptor[] = [
  {
    uri: _0,
    descriptors: {
      unicodeRange:
