...
import { DEFAULT_SIDEBAR, FONT_FAMILY, ROUNDNESS } from "@hidewhiteboard/common";

import { newElementWith } from "@hidewhiteboard/element";
import * as sizeHelpers from "@hidewhiteboard/element";

import type { LocalPoint } from "@hidewhiteboard/math";
...
import type { NormalizedZoomValue } from "@hidewhiteboard/hidewhiteboard/types";
...
describe("restoreElements", () => {
  ...
  it("should not call isInvisiblySmallElement when element is a selection element", () => {
    const selectionEl = { type: "selection" } as hidewhiteboardElement;
  ...
  it("should restore text element correctly passing value for each attribute", () => {
    ...
    const restoredText = restore.restoreElements(
      [textElement],
      null,
    )[0] as hidewhiteboardTextElement;
  ...
  it("should restore freedraw element correctly", () => {
    ...
    const restoredFreedraw = restore.restoreElements(
      [freedrawElement],
      null,
    )[0] as hidewhiteboardFreeDrawElement;
  ...
  it("should restore line and draw elements correctly", () => {
    ...
    const restoredLine = restoredElements[0] as hidewhiteboardLinearElement;
    const restoredDraw = restoredElements[1] as hidewhiteboardLinearElement;
  ...
  it("should restore arrow element correctly", () => {
    ...
    const restoredArrow = restoredElements[0] as hidewhiteboardLinearElement;
  ...
  it("when element.points of a line element is not an array", () => {
    ...
    const restoredLine = restore.restoreElements(
      [lineElement],
      null,
    )[0] as hidewhiteboardLinearElement;
  ...
  it("when the number of points of a line is greater or equal 2", () => {
    ...
    const restoredLine_0 = restoredElements[0] as hidewhiteboardLinearElement;
    const restoredLine_1 = restoredElements[1] as hidewhiteboardLinearElement;
...
describe("restoreAppState", () => {
  ...
  it("when imported data state has a not allowed hidewhiteboard Element Types", () => {
    const stubImportedAppState: any = getDefaultAppState();

    stubImportedAppState.activeTool = "not allowed hidewhiteboard Element Types";
    const stubLocalAppState = getDefaultAppState();
