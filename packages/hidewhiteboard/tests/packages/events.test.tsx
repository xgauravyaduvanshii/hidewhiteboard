...
import { Hidewhiteboard, CaptureUpdateAction } from "../../index";
...
describe("event callbacks", () => {
  ...
  it("should trigger onChange on render", async () => {
    ...
    hidewhiteboardAPI.onChange(onChange);
    API.updateScene({
  ...
  it("should trigger onPointerDown/onPointerUp on canvas pointerDown/pointerUp", async () => {
    ...
    hidewhiteboardAPI.onPointerDown(onPointerDown);
    hidewhiteboardAPI.onPointerUp(onPointerUp);
