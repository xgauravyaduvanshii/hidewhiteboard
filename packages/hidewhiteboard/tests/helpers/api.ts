...
import { pointFrom, type LocalPoint, type Radians } from "@hidewhiteboard/math";

import { DEFAULT_VERTICAL_ALIGN, ROUNDNESS, assertNever } from "@hidewhiteboard/common";
...
import { isLinearElementType } from "@hidewhiteboard/element";
import { getSelectedElements } from "@hidewhiteboard/element";
import { selectGroupsForSelectedElements } from "@hidewhiteboard/element";

import { FONT_SIZES } from "@hidewhiteboard/common";
...
import type { Mutable } from "@hidewhiteboard/common/utility-types";
...
export class API {
  ...
  static setElements = (elements: readonly hidewhiteboardElement[]) => {
    act(() => {
      h.elements = elements;
    });
  };

  static setSelectedElements = (elements: hidewhiteboardElement[], editingGroupId?: string | null) => {
    act(() => {
      h.setState({
        ...selectGroupsForSelectedElements(
        {
          ...
          selectedElementIds: elements.reduce((acc, element) => {
            acc[element.id] = true;
            return acc;
          }, {} as Record<hidewhiteboardElement["id"], true>),
        },
        elements,
        h.state,
        h.app,
  ...
  static updateElement = <T extends hidewhiteboardElement>(
  ...
  static getSelectedElement = (): hidewhiteboardElement => {
  ...
  static getElement = <T extends hidewhiteboardElement>(element: T): T => {
    return h.app.scene.getElementsMapIncludingDeleted().get(element.id) as T || element;
  }

  static createElement = <
    T extends Exclude<hidewhiteboardElementType, "selection"> = "rectangle",
  >({
    // @ts-ignore
    type = "rectangle",
    id,
    ...
    id?: string;
    isDeleted?: boolean;
    frameId?: hidewhiteboardElement["id"] | null;
    index?: hidewhiteboardElement["index"];
    groupIds?: hidewhiteboardElement["groupIds"];
    // generic element props
    strokeColor?: hidewhiteboardGenericElement["strokeColor"];
    backgroundColor?: hidewhiteboardGenericElement["backgroundColor"];
    fillStyle?: hidewhiteboardGenericElement["fillStyle"];
    strokeWidth?: hidewhiteboardGenericElement["strokeWidth"];
    strokeStyle?: hidewhiteboardGenericElement["strokeStyle"];
    roundness?: hidewhiteboardGenericElement["roundness"];
    roughness?: hidewhiteboardGenericElement["roughness"];
    opacity?: hidewhiteboardGenericElement["opacity"];
    // text props
    text?: T extends "text" ? hidewhiteboardTextElement["text"] : never;
    fontSize?: T extends "text" ? hidewhiteboardTextElement["fontSize"] : never;
    fontFamily?: T extends "text" ? hidewhiteboardTextElement["fontFamily"] : never;
    textAlign?: T extends "text" ? hidewhiteboardTextElement["textAlign"] : never;
    verticalAlign?: T extends "text"
      ? hidewhiteboardTextElement["verticalAlign"]
      : never;
    boundElements?: hidewhiteboardGenericElement["boundElements"];
    containerId?: T extends "text"
      ? hidewhiteboardTextElement["containerId"]
      : never;
    points?: T extends "arrow" | "line" | "freedraw" ? readonly LocalPoint[] : never;
    locked?: boolean;
    fileId?: T extends "image" ? string : never;
    scale?: T extends "image" ? hidewhiteboardImageElement["scale"] : never;
    status?: T extends "image" ? hidewhiteboardImageElement["status"] : never;
    startBinding?: T extends "arrow"
      ? hidewhiteboardArrowElement["startBinding"] | hidewhiteboardElbowArrowElement["startBinding"]
      : never;
    endBinding?: T extends "arrow"
      ? hidewhiteboardArrowElement["endBinding"] | hidewhiteboardElbowArrowElement["endBinding"]
      : never;
    startArrowhead?: T extends "arrow"
      ? hidewhiteboardArrowElement["startArrowhead"] | hidewhiteboardElbowArrowElement["startArrowhead"]
      : never;
    endArrowhead?: T extends "arrow"
      ? hidewhiteboardArrowElement["endArrowhead"] | hidewhiteboardElbowArrowElement["endArrowhead"]
      : never;
    elbowed?: boolean;
    ...
    ? hidewhiteboardMagicFrameElement
    : hidewhiteboardGenericElement => {
    let element: Mutable<hidewhiteboardElement> = null!;
  ...
  static createTextContainer = (opts?: {
    frameId?: hidewhiteboardElement["id"];
    groupIds?: hidewhiteboardElement["groupIds"];
    label?: {
      text?: string;
      frameId?: hidewhiteboardElement["id"] | null;
