...
import { KEYS, arrayToMap, getLineHeight } from "@hidewhiteboard/common";
...
import { mockMermaidTohidewhiteboard } from "./helpers/mocks";
...
vi.mock("@hidewhiteboard/common", async (importOriginal) => {
...
describe("Paste bound text container", () => {
  ...
  const textElement = {
    ...
    fontSize: 20,
    fontFamily: 1,
    text: "hidewhiteboard is a\nvirtual \nopensource \nwhiteboard for \nsketching \nhand-drawn like\ndiagrams",
    baseline: 168,
    textAlign: "center",
    verticalAlign: "middle",
    containerId: container.id,
    originalText:
      "hidewhiteboard is a virtual opensource whiteboard for sketching hand-drawn like diagrams",
  };

  it("should fix ellipse bounding box", async () => {
    const data = JSON.stringify({
      type: "hidewhiteboard/clipboard",
...
describe("clipboard - pasting mermaid definition", () => {
  beforeAll(() => {
    mockMermaidTohidewhiteboard({
      parseMermaidTohidewhiteboard: async (definition) => {
