...
import { KEYS, reseed } from "@hidewhiteboard/common";
...
describe("move element", () => {
  it("rectangle", async () => {
    const { getByToolName, container } = await render(<Hidewhiteboard />);
  ...
  it("rectangles with binding arrow", async () => {
    ...
    act(() => {
      ...
      bindBindingElement(
        arrow.get() as NonDeleted<hidewhiteboardArrowElement>,
        rectA.get(),
        "orbit",
        "start",
        h.app.scene,
