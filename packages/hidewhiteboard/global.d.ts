interface Window {
  ClipboardItem: any;
  __HIDEWHITEBOARD_SHA__: string | undefined;
  HIDEWHITEBOARD_ASSET_PATH: string | string[] | undefined;
  HIDEWHITEBOARD_THROTTLE_RENDER: boolean | undefined;
  DEBUG_FRACTIONAL_INDICES: boolean | undefined;
  HIDEWHITEBOARD_EXPORT_SOURCE: string;
  gtag: Function;
  sa_event: Function;
