...
import { normalizeLink, toValidURL } from "@hidewhiteboard/common";
import { hashString } from "@hidewhiteboard/element";
import { getUncroppedWidthAndHeight } from "@hidewhiteboard/element";
import {
  createPlaceholderEmbeddableLabel,
  getEmbedLink,
} from "@hidewhiteboard/element";
import { LinearElementEditor } from "@hidewhiteboard/element";
import { getBoundTextElement, getContainerElement } from "@hidewhiteboard/element";
import { getLineHeightInPx } from "@hidewhiteboard/element";
import {
  isArrowElement,
  isIframeLikeElement,
...
import { getCornerRadius, isPathALoop } from "@hidewhiteboard/element";
...
const renderElementToSvg = (
  ...
  const addToRoot = (node: SVGElement, element: hidewhiteboardElement) => {
    if (isTestEnv()) {
  ...
  switch (element.type) {
    ...
    case "embeddable": {
      ...
      const label: hidewhiteboardElement =
