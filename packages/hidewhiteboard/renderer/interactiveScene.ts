...
import { renderSelectionElement } from "@hidewhiteboard/element";
...
const renderElementsBoxHighlight = (
  context: CanvasRenderingContext2D,
  appState: InteractiveCanvasAppState,
  elements: NonDeleted<hidewhiteboardElement>[],
  ...
  const getSelectionFromElements = (elements: hidewhiteboardElement[]) => {
...
const renderCropHandles = (
  ...
  renderConfig: InteractiveCanvasRenderConfig,
  appState: InteractiveCanvasAppState,
  croppingElement: hidewhiteboardImageElement,
  elementsMap: ElementsMap,
): void => {
...
const renderTextBox = (
  text: NonDeleted<hidewhiteboardTextElement>,
  context: CanvasRenderingContext2D,
  appState: InteractiveCanvasAppState,
...
const _renderInteractiveScene = ({
  ...
  let editingLinearElement: NonDeleted<hidewhiteboardLinearElement> | undefined =
    undefined;
  ...
  visibleElements.forEach((element) => {
    ...
    if (
      ...
      if (element) {
        editingLinearElement = element as NonDeleted<hidewhiteboardLinearElement>;
      }
    }
  });
  ...
  if (
    ...
    renderLinearPointHandles(
      context,
      appState,
      selectedElements[0] as NonDeleted<hidewhiteboardLinearElement>,
      elementsMap,
    );
  }
  ...
  if (
    ...
    if (
      ...
      renderLinearPointHandles(
        context,
        appState,
        selectedElements[0] as hidewhiteboardLinearElement,
        elementsMap,
      );
    }
