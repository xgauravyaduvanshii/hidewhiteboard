...
import { getElementsOverlappingFrame } from "@hidewhiteboard/element";
...
export type ExportedElements = readonly NonDeletedhidewhiteboardElement[] & {
...
export const prepareElementsForExport = (
  ...
  let exportingFrame: hidewhiteboardFrameLikeElement | null = null;
...
export const exportCanvas = async (
    ...
    if (type === "svg") {
      return fileSave(
        ...
        }),
        {
          ...
          name,
          extension: appState.exportEmbedScene ? "hidewhiteboard.svg" : "svg",
  ...
  if (type === "png") {
    ...
    return fileSave(blob, {
      ...
      name,
      extension: appState.exportEmbedScene ? "hidewhiteboard.png" : "png",
