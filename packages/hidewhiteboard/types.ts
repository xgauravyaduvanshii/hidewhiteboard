...
import type { LinearElementEditor } from "@hidewhiteboard/element";

import type { MaybeTransformHandleType } from "@hidewhiteboard/element";
...
import type {
  ...
  hidewhiteboardNonSelectionElement,
  BindMode,
...
import type { GlobalPoint } from "@hidewhiteboard/math";
...
export type BinaryFiles = Record<hidewhiteboardElement["id"], BinaryFileData>;
...
export type ElementOrToolType = hidewhiteboardElementType | ToolType | "custom";
...
export interface AppState {
   ...
   */
  newElement: NonDeleted<hidewhiteboardNonSelectionElement> | null;
  /**
   * for a single element that's being resized
   * - set on pointer down when it's selected and the active tool is selection
   */
  resizingElement: NonDeletedhidewhiteboardElement | null;
  /**
   ...
   */
  multiElement: NonDeleted<hidewhiteboardLinearElement> | null;
  /**
   * decoupled from newElement, dragging selection only creates selectionElement
   * - set on pointer down, updated during pointer move
   */
  selectionElement: NonDeletedhidewhiteboardElement | null;
  isBindingEnabled: boolean;
  startBoundElement: NonDeleted<hidewhiteboardBindableElement> | null;
  suggestedBinding: {
    element: NonDeleted<hidewhiteboardBindableElement>;
    midPoint?: GlobalPoint;
  } | null;
  frameToHighlight: NonDeleted<hidewhiteboardFrameLikeElement> | null;
  frameRendering: {
    enabled: boolean;
    name: boolean;
    outline: boolean;
  ...
  elementsToHighlight: NonDeleted<hidewhiteboardElement>[] | null;
  /**
   * set when a new text is created or when an existing text is being edited
   */
  editingTextElement: NonDeletedhidewhiteboardElement | null;
  activeTool: {
    /**
  ...
  currentItemFillStyle: hidewhiteboardElement["fillStyle"];
  currentItemStrokeWidth: number;
  currentItemStrokeStyle: hidewhiteboardElement["strokeStyle"];
  ...
  openDialog:
    ...
    | { name: "commandPalette" }
    | { name: "settings" }
    | { name: "elementLinkSelector"; sourceElementId: hidewhiteboardElement["id"] };
  /**
  ...
  /** image cropping */
  isCropping: boolean;
  croppingElementId: hidewhiteboardElement["id"] | null;

  /** null if no search matches found / search closed */
  searchMatches: Readonly<{
    focusedId: hidewhiteboardElement["id"] | null;
...
export type LibraryItem_v1 = readonly NonDeleted<hidewhiteboardElement>[];
/** @deprecated legacy: do not use outside of migration paths */
...
export type LibraryItem = {
  ...
  elements: readonly NonDeleted<hidewhiteboardElement>[];
...
export type hidewhiteboardInitialDataState = Merge<
  ImportedDataState,
  {
...
export interface hidewhiteboardProps {
  onChange?: (
  ...
  initialData?:
    | (() => MaybePromise<hidewhiteboardInitialDataState | null>)
    | MaybePromise<hidewhiteboardInitialDataState | null>;
  hidewhiteboardAPI?: (api: hidewhiteboardImperativeAPI) => void;
   ...
   */
  onDuplicate?: (
    nextElements: readonly hidewhiteboardElement[],
    /** excludes the duplicated elements */
    prevElements: readonly hidewhiteboardElement[],
  ) => hidewhiteboardElement[] | void;
  renderTopLeftUI?: (
    isMobile: boolean,
    appState: UIAppState,
  ) => JSX.Element | null;
  ...
  renderEmbeddable?: (
    element: NonDeleted<hidewhiteboardEmbeddableElement>,
    appState: AppState,
  ) => JSX.Element | null;
  aiEnabled?: boolean;
...
// hidewhiteboard package index.tsx.
...
export type AppClassProperties = {
  ...
  hidewhiteboardContainerValue: App["hidewhiteboardContainerValue"];
...
export type PointerDownState = Readonly<{
  ...
  originalElements: Map<string, NonDeleted<hidewhiteboardElement>>;
  resize: {
  ...
  hit: {
    ...
    // pointer down event
    element: NonDeleted<hidewhiteboardElement> | null;
...
export interface hidewhiteboardImperativeAPI {
...
export type FrameNameBoundsCache = {
  get: (
    frameElement: hidewhiteboardFrameLikeElement | hidewhiteboardMagicFrameElement,
  ) => FrameNameBounds | null;
  _cache: Map<
    string,
    FrameNameBounds & {
      zoom: AppState["zoom"]["value"];
      versionNonce: hidewhiteboardFrameLikeElement["versionNonce"];
    }
  >;
};
...
export type EmbedsValidationStatus = Map<
  hidewhiteboardIframeLikeElement["id"],
  boolean
>;

export type ElementsPendingErasure = Set<hidewhiteboardElement["id"]>;

export type PendinghidewhiteboardElements = hidewhiteboardElement[];
...
export type GenerateDiagramToCode = (props: {
  frame: hidewhiteboardMagicFrameElement;
  children: readonly hidewhiteboardElement[];
