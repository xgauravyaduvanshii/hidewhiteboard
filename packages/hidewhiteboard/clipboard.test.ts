...
describe("parseClipboard()", () => {
  it("should parse JSON as plaintext if not hidewhiteboard-api/clipboard data", async () => {
    let text;
    let clipboardData;
    // -------------------------------------------------------------------------
  ...
  it("should parse valid hidewhiteboard JSON if inside text/plain", async () => {
  ...
  it("should parse valid hidewhiteboard JSON if inside text/html", async () => {
    const rect = API.createElement({ type: "rectangle" });
