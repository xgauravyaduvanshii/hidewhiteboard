...
import polyfill from "./packages/hidewhiteboard/polyfill";
import { yellow } from "./packages/hidewhiteboard/tests/helpers/colorize";
import { testPolyfills } from "./packages/hidewhiteboard/tests/helpers/polyfills";
...
Object.defineProperty(window, "HIDEWHITEBOARD_ASSET_PATH", {
...
vi.mock(
  "./packages/hidewhiteboard/fonts/hidewhiteboardFontFace",
  async (importOriginal) => {
    const mod = await importOriginal<
      typeof import("./packages/hidewhiteboard/fonts/hidewhiteboardFontFace")
    >();
    const hidewhiteboardFontFaceImpl = mod.hidewhiteboardFontFace;

    return {
      ...mod,
      hidewhiteboardFontFace: class extends hidewhiteboardFontFaceImpl {
